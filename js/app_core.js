...
const crimeReports = [
    { title: "10-31 BURGLARY: A sentient swarm of micro-drones was caught in the act of stealing a jar of weaponized pickles. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 15 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours has brazenly walked out the front door with the letter 'E' off of every neon sign on Main Street. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 10 },
    { title: "10-WUT GRAND THEFT: A suspect claiming to be a sovereign citizen of the candy aisle is attempting to fence every single tube of mint toothpaste in Sector 4. Officers are highly confused as to why anyone would want this.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A rogue delivery driver is currently fleeing the scene after robbing the store of three left shoes from the local bowling alley. Officers are highly confused as to why anyone would want this.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: Someone disguised as a very suspicious potted plant is trying to trade a fake Rolex for a half-eaten ham sandwich out of the precinct breakroom. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 500 },
    { title: "10-WUT GRAND THEFT: A sentient swarm of micro-drones is holding the manager hostage until they hand over exactly 100 individual chocolate bars. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 15 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours has successfully stolen exactly 100 individual chocolate bars. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A suspect in a ghillie suit made of receipts is currently fleeing the scene after robbing the store of every single tube of mint toothpaste in Sector 4. The suspect claims it is a matter of severe national security.", priority: "low", points: 500 },
    { title: "10-WUT GRAND THEFT: A citizen who clearly hasn't slept in 72 hours is trying to trade a fake Rolex for a single slice of American cheese, heavily guarded. Bystanders are cheering the suspect on.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: A guy who brought a stolen forklift into a convenience store was caught in the act of stealing a jar of weaponized pickles. Officers are highly confused as to why anyone would want this.", priority: "low", points: 500 },
    { title: "10-31 BURGLARY: A suspect claiming to be a sovereign citizen of the candy aisle has successfully stolen a single, incredibly stale potato chip. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: A citizen who clearly hasn't slept in 72 hours is attempting to fence every single tube of mint toothpaste in Sector 4. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours is trying to trade a fake Rolex for the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Suspect is demanding a police escort to safety.", priority: "low", points: 15 },
    { title: "10-WUT GRAND THEFT: A suspect claiming to be a sovereign citizen of the candy aisle was caught in the act of stealing a half-eaten ham sandwich out of the precinct breakroom. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 25 },
    { title: "10-WUT GRAND THEFT: A man carrying a remarkably large burlap sack with a dollar sign on it has brazenly walked out the front door with a jar of weaponized pickles. Officers are highly confused as to why anyone would want this.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: A suspect claiming to be a sovereign citizen of the candy aisle is holding the manager hostage until they hand over a 50-pound wheel of synthetic cheese. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 25 },
    { title: "10-WUT GRAND THEFT: A fully armed tactical squad is trying to trade a fake Rolex for exactly 100 individual chocolate bars. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 300 },
    { title: "10-31 BURGLARY: A suspect in a ghillie suit made of receipts has brazenly walked out the front door with exactly 100 individual chocolate bars. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 500 },
    { title: "10-WUT GRAND THEFT: A man carrying a remarkably large burlap sack with a dollar sign on it is trying to trade a fake Rolex for three left shoes from the local bowling alley. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: An individual wearing a ski mask completely backwards is trying to trade a fake Rolex for the letter 'E' off of every neon sign on Main Street. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A man carrying a remarkably large burlap sack with a dollar sign on it is trying to trade a fake Rolex for every single tube of mint toothpaste in Sector 4. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 10 },
    { title: "10-31 BURGLARY: A fully armed tactical squad is trying to trade a fake Rolex for the Mayor's favorite coffee mug. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: An individual wearing a ski mask completely backwards is holding the manager hostage until they hand over a single, incredibly stale potato chip. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 500 },
    { title: "10-31 BURGLARY: A suspect claiming to be a sovereign citizen of the candy aisle has successfully stolen the left turn signal from a police cruiser. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: A rogue delivery driver is attempting to fence the Mayor's favorite coffee mug. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 10 },
    { title: "10-WUT GRAND THEFT: A fully armed tactical squad has successfully stolen a half-eaten ham sandwich out of the precinct breakroom. Suspect is demanding a police escort to safety.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: A suspect claiming to be a sovereign citizen of the candy aisle was caught in the act of stealing the beloved local animatronic mascot known as 'Tickle Tiny Tim'. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: A fully armed tactical squad is trying to trade a fake Rolex for a single, incredibly stale potato chip. Bystanders are cheering the suspect on.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: Someone disguised as a very suspicious potted plant has successfully stolen the letter 'E' off of every neon sign on Main Street. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 500 },
    { title: "10-WUT GRAND THEFT: Someone disguised as a very suspicious potted plant is attempting to fence three left shoes from the local bowling alley. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 300 },
    { title: "10-31 BURGLARY: A citizen who clearly hasn't slept in 72 hours is attempting to fence a single, incredibly stale potato chip. Bystanders are cheering the suspect on.", priority: "low", points: 15 },
    { title: "10-WUT GRAND THEFT: A rogue delivery driver is attempting to fence every single tube of mint toothpaste in Sector 4. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: A suspect in a ghillie suit made of receipts is attempting to fence a restraining order, physically stealing the paper it was printed on. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 10 },
    { title: "10-31 BURGLARY: A man carrying a remarkably large burlap sack with a dollar sign on it is holding the manager hostage until they hand over the Mayor's favorite coffee mug. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: Someone disguised as a very suspicious potted plant has successfully stolen the beloved local animatronic mascot known as 'Tickle Tiny Tim'. The suspect claims it is a matter of severe national security.", priority: "low", points: 15 },
    { title: "10-WUT GRAND THEFT: A rogue delivery driver is currently fleeing the scene after robbing the store of a 50-pound wheel of synthetic cheese. Officers are highly confused as to why anyone would want this.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A suspect claiming to be a sovereign citizen of the candy aisle is trying to trade a fake Rolex for a jar of weaponized pickles. Suspect is demanding a police escort to safety.", priority: "low", points: 50 },
    { title: "10-WUT GRAND THEFT: Someone disguised as a very suspicious potted plant has successfully stolen the letter 'E' off of every neon sign on Main Street. Suspect is demanding a police escort to safety.", priority: "low", points: 300 },
    { title: "10-31 BURGLARY: An individual wearing a ski mask completely backwards is trying to trade a fake Rolex for a single slice of American cheese, heavily guarded. The suspect claims it is a matter of severe national security.", priority: "low", points: 10 },
    { title: "10-WUT GRAND THEFT: A fully armed tactical squad is currently fleeing the scene after robbing the store of the concept of personal space. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 15 },
    { title: "10-WUT GRAND THEFT: A citizen who clearly hasn't slept in 72 hours has successfully stolen a single slice of American cheese, heavily guarded. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 10 },
    { title: "10-49 SHOPLIFTING: A sentient swarm of micro-drones has brazenly walked out the front door with the Mayor's favorite coffee mug. Suspect is demanding a police escort to safety.", priority: "low", points: 25 },
    { title: "10-49 SHOPLIFTING: A man carrying a remarkably large burlap sack with a dollar sign on it is currently fleeing the scene after robbing the store of the concept of personal space. Officers are highly confused as to why anyone would want this.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: Someone disguised as a very suspicious potted plant has successfully stolen a 50-pound wheel of synthetic cheese. Suspect is demanding a police escort to safety.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: An individual wearing a ski mask completely backwards is holding the manager hostage until they hand over a single, incredibly stale potato chip. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: Someone disguised as a very suspicious potted plant is trying to trade a fake Rolex for a single slice of American cheese, heavily guarded. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours is currently fleeing the scene after robbing the store of exactly 100 individual chocolate bars. The suspect claims it is a matter of severe national security.", priority: "low", points: 500 },
    { title: "10-WUT GRAND THEFT: A suspect claiming to be a sovereign citizen of the candy aisle has brazenly walked out the front door with the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: A fully armed tactical squad is attempting to fence an entire sleeping human. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 10 },
    { title: "10-31 BURGLARY: A citizen who clearly hasn't slept in 72 hours is holding the manager hostage until they hand over the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Bystanders are cheering the suspect on.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A suspect claiming to be a sovereign citizen of the candy aisle has successfully stolen a half-eaten ham sandwich out of the precinct breakroom. Bystanders are cheering the suspect on.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: A rogue delivery driver has brazenly walked out the front door with a 50-pound wheel of synthetic cheese. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours is currently fleeing the scene after robbing the store of the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Suspect is demanding a police escort to safety.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A citizen who clearly hasn't slept in 72 hours was caught in the act of stealing an entire sleeping human. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 50 },
    { title: "10-WUT GRAND THEFT: Someone disguised as a very suspicious potted plant is attempting to fence a jar of weaponized pickles. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: Someone disguised as a very suspicious potted plant has successfully stolen the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 50 },
    { title: "10-49 SHOPLIFTING: A suspect claiming to be a sovereign citizen of the candy aisle has successfully stolen the letter 'E' off of every neon sign on Main Street. The suspect claims it is a matter of severe national security.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A suspect claiming to be a sovereign citizen of the candy aisle has brazenly walked out the front door with a jar of weaponized pickles. Officers are highly confused as to why anyone would want this.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: A highly coordinated team of cyber-thieves has successfully stolen a restraining order, physically stealing the paper it was printed on. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A rogue delivery driver is holding the manager hostage until they hand over a single slice of American cheese, heavily guarded. Bystanders are cheering the suspect on.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A suspect in a ghillie suit made of receipts is attempting to fence a single slice of American cheese, heavily guarded. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A suspect in a ghillie suit made of receipts is currently fleeing the scene after robbing the store of a restraining order, physically stealing the paper it was printed on. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 25 },
    { title: "10-WUT GRAND THEFT: A citizen who clearly hasn't slept in 72 hours is holding the manager hostage until they hand over a single slice of American cheese, heavily guarded. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: A highly coordinated team of cyber-thieves is holding the manager hostage until they hand over a single slice of American cheese, heavily guarded. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A guy who brought a stolen forklift into a convenience store is currently fleeing the scene after robbing the store of an entire sleeping human. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A citizen who clearly hasn't slept in 72 hours is holding the manager hostage until they hand over the left turn signal from a police cruiser. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 25 },
    { title: "10-31 BURGLARY: A guy who brought a stolen forklift into a convenience store was caught in the act of stealing three left shoes from the local bowling alley. Officers are highly confused as to why anyone would want this.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: A man carrying a remarkably large burlap sack with a dollar sign on it was caught in the act of stealing every single tube of mint toothpaste in Sector 4. Suspect is demanding a police escort to safety.", priority: "low", points: 25 },
    { title: "10-31 BURGLARY: A suspect claiming to be a sovereign citizen of the candy aisle is trying to trade a fake Rolex for every single tube of mint toothpaste in Sector 4. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A guy who brought a stolen forklift into a convenience store is attempting to fence the concept of personal space. Suspect is demanding a police escort to safety.", priority: "low", points: 500 },
    { title: "10-WUT GRAND THEFT: A fully armed tactical squad is attempting to fence the Mayor's favorite coffee mug. Suspect is demanding a police escort to safety.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: A suspect in a ghillie suit made of receipts has brazenly walked out the front door with the left turn signal from a police cruiser. The suspect claims it is a matter of severe national security.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: Someone disguised as a very suspicious potted plant has brazenly walked out the front door with an entire sleeping human. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: A sentient swarm of micro-drones has brazenly walked out the front door with a single, incredibly stale potato chip. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A fully armed tactical squad was caught in the act of stealing a restraining order, physically stealing the paper it was printed on. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours is attempting to fence a 50-pound wheel of synthetic cheese. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A suspect claiming to be a sovereign citizen of the candy aisle was caught in the act of stealing a 50-pound wheel of synthetic cheese. Bystanders are cheering the suspect on.", priority: "low", points: 15 },
    { title: "10-49 SHOPLIFTING: A guy who brought a stolen forklift into a convenience store is currently fleeing the scene after robbing the store of the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: A highly coordinated team of cyber-thieves is currently fleeing the scene after robbing the store of a single slice of American cheese, heavily guarded. Suspect is demanding a police escort to safety.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A highly coordinated team of cyber-thieves is trying to trade a fake Rolex for the Mayor's favorite coffee mug. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 300 },
    { title: "10-31 BURGLARY: A fully armed tactical squad is holding the manager hostage until they hand over a 50-pound wheel of synthetic cheese. Suspect is demanding a police escort to safety.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A fully armed tactical squad has brazenly walked out the front door with exactly 100 individual chocolate bars. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A citizen who clearly hasn't slept in 72 hours is holding the manager hostage until they hand over three left shoes from the local bowling alley. Bystanders are cheering the suspect on.", priority: "low", points: 25 },
    { title: "10-WUT GRAND THEFT: A guy who brought a stolen forklift into a convenience store is attempting to fence a single slice of American cheese, heavily guarded. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A guy who brought a stolen forklift into a convenience store was caught in the act of stealing a jar of weaponized pickles. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 50 },
    { title: "10-49 SHOPLIFTING: A sentient swarm of micro-drones was caught in the act of stealing the left turn signal from a police cruiser. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: A guy who brought a stolen forklift into a convenience store has brazenly walked out the front door with an entire sleeping human. Officers are highly confused as to why anyone would want this.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: An individual wearing a ski mask completely backwards has brazenly walked out the front door with every single tube of mint toothpaste in Sector 4. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: Someone disguised as a very suspicious potted plant has brazenly walked out the front door with the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: Someone disguised as a very suspicious potted plant is holding the manager hostage until they hand over the concept of personal space. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: A man carrying a remarkably large burlap sack with a dollar sign on it is attempting to fence a single slice of American cheese, heavily guarded. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 10 },
    { title: "10-31 BURGLARY: A sentient swarm of micro-drones has successfully stolen an entire sleeping human. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: A suspect claiming to be a sovereign citizen of the candy aisle was caught in the act of stealing exactly 100 individual chocolate bars. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: An individual wearing a ski mask completely backwards has successfully stolen exactly 100 individual chocolate bars. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 10 },
    { title: "10-WUT GRAND THEFT: A sentient swarm of micro-drones is trying to trade a fake Rolex for the beloved local animatronic mascot known as 'Tickle Tiny Tim'. The suspect claims it is a matter of severe national security.", priority: "low", points: 500 },
    { title: "10-31 BURGLARY: A guy who brought a stolen forklift into a convenience store has brazenly walked out the front door with a 50-pound wheel of synthetic cheese. The suspect claims it is a matter of severe national security.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A fully armed tactical squad is currently fleeing the scene after robbing the store of a half-eaten ham sandwich out of the precinct breakroom. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 500 },
    { title: "10-31 BURGLARY: A guy who brought a stolen forklift into a convenience store has brazenly walked out the front door with an entire sleeping human. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 25 },
    { title: "10-49 SHOPLIFTING: A guy who brought a stolen forklift into a convenience store is trying to trade a fake Rolex for the beloved local animatronic mascot known as 'Tickle Tiny Tim'. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 10 },
    { title: "10-31 BURGLARY: A fully armed tactical squad is currently fleeing the scene after robbing the store of exactly 100 individual chocolate bars. The suspect claims it is a matter of severe national security.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: Someone disguised as a very suspicious potted plant was caught in the act of stealing a single, incredibly stale potato chip. Officers are highly confused as to why anyone would want this.", priority: "low", points: 500 },
    { title: "10-31 BURGLARY: A guy who brought a stolen forklift into a convenience store is attempting to fence three left shoes from the local bowling alley. The suspect claims it is a matter of severe national security.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A suspect claiming to be a sovereign citizen of the candy aisle is currently fleeing the scene after robbing the store of every single tube of mint toothpaste in Sector 4. The suspect claims it is a matter of severe national security.", priority: "low", points: 25 },
    { title: "10-WUT GRAND THEFT: A fully armed tactical squad is attempting to fence a single slice of American cheese, heavily guarded. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 25 },
    { title: "10-49 SHOPLIFTING: A rogue delivery driver has successfully stolen the beloved local animatronic mascot known as 'Tickle Tiny Tim'. Officers are highly confused as to why anyone would want this.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: A suspect claiming to be a sovereign citizen of the candy aisle is attempting to fence the beloved local animatronic mascot known as 'Tickle Tiny Tim'. The suspect claims it is a matter of severe national security.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A rogue delivery driver is trying to trade a fake Rolex for a single slice of American cheese, heavily guarded. Officers are highly confused as to why anyone would want this.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: A fully armed tactical squad was caught in the act of stealing the concept of personal space. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: A suspect in a ghillie suit made of receipts is holding the manager hostage until they hand over three left shoes from the local bowling alley. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 15 },
    { title: "10-WUT GRAND THEFT: An individual wearing a ski mask completely backwards was caught in the act of stealing a 50-pound wheel of synthetic cheese. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: An individual wearing a ski mask completely backwards has successfully stolen the letter 'E' off of every neon sign on Main Street. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 50 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours is holding the manager hostage until they hand over a 50-pound wheel of synthetic cheese. Officers are highly confused as to why anyone would want this.", priority: "low", points: 10 },
    { title: "10-31 BURGLARY: An individual wearing a ski mask completely backwards has brazenly walked out the front door with the Mayor's favorite coffee mug. Bystanders are cheering the suspect on.", priority: "low", points: 50 },
    { title: "10-WUT GRAND THEFT: An individual wearing a ski mask completely backwards is trying to trade a fake Rolex for an entire sleeping human. Bystanders are cheering the suspect on.", priority: "low", points: 50 },
    { title: "10-49 SHOPLIFTING: A suspect in a ghillie suit made of receipts is holding the manager hostage until they hand over an entire sleeping human. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: A highly coordinated team of cyber-thieves has brazenly walked out the front door with a half-eaten ham sandwich out of the precinct breakroom. Bystanders are cheering the suspect on.", priority: "low", points: 10 },
    { title: "10-WUT GRAND THEFT: A man carrying a remarkably large burlap sack with a dollar sign on it was caught in the act of stealing every single tube of mint toothpaste in Sector 4. The suspect claims it is a matter of severe national security.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: Someone disguised as a very suspicious potted plant is trying to trade a fake Rolex for the letter 'E' off of every neon sign on Main Street. Officers report the suspect is desperately trying to eat the evidence.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: Someone disguised as a very suspicious potted plant has brazenly walked out the front door with every single tube of mint toothpaste in Sector 4. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 50 },
    { title: "10-49 SHOPLIFTING: A fully armed tactical squad is attempting to fence a single, incredibly stale potato chip. Officers are highly confused as to why anyone would want this.", priority: "low", points: 50 },
    { title: "10-WUT GRAND THEFT: A man carrying a remarkably large burlap sack with a dollar sign on it is attempting to fence the Mayor's favorite coffee mug. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: A rogue delivery driver is attempting to fence the left turn signal from a police cruiser. Suspect is demanding a police escort to safety.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A citizen who clearly hasn't slept in 72 hours is trying to trade a fake Rolex for a single slice of American cheese, heavily guarded. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 500 },
    { title: "10-49 SHOPLIFTING: A sentient swarm of micro-drones is currently fleeing the scene after robbing the store of three left shoes from the local bowling alley. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 300 },
    { title: "10-WUT GRAND THEFT: An individual wearing a ski mask completely backwards is attempting to fence a 50-pound wheel of synthetic cheese. The suspect claims it is a matter of severe national security.", priority: "low", points: 10 },
    { title: "10-WUT GRAND THEFT: An individual wearing a ski mask completely backwards is attempting to fence the Mayor's favorite coffee mug. The suspect claims they needed it to fuel their time machine.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: A suspect claiming to be a sovereign citizen of the candy aisle is currently fleeing the scene after robbing the store of the Mayor's favorite coffee mug. Bystanders are cheering the suspect on.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A fully armed tactical squad is trying to trade a fake Rolex for a 50-pound wheel of synthetic cheese. Suspect tripped and dropped everything immediately after leaving the store.", priority: "low", points: 15 },
    { title: "10-31 BURGLARY: A man carrying a remarkably large burlap sack with a dollar sign on it has successfully stolen a half-eaten ham sandwich out of the precinct breakroom. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 15 },
    { title: "10-WUT GRAND THEFT: Someone disguised as a very suspicious potted plant is trying to trade a fake Rolex for the concept of personal space. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 10 },
    { title: "10-49 SHOPLIFTING: A man carrying a remarkably large burlap sack with a dollar sign on it is currently fleeing the scene after robbing the store of the left turn signal from a police cruiser. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 25 },
    { title: "10-31 BURGLARY: Someone disguised as a very suspicious potted plant is attempting to fence the left turn signal from a police cruiser. The stolen item is currently leaking a strange green fluid.", priority: "low", points: 300 },
    { title: "10-49 SHOPLIFTING: A fully armed tactical squad has brazenly walked out the front door with the left turn signal from a police cruiser. Officers are highly confused as to why anyone would want this.", priority: "low", points: 10 },
    { title: "10-49 SHOPLIFTING: A suspect claiming to be a sovereign citizen of the candy aisle is attempting to fence a 50-pound wheel of synthetic cheese. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: A suspect in a ghillie suit made of receipts was caught in the act of stealing a restraining order, physically stealing the paper it was printed on. Suspect left an I.O.U. written in crayon on a napkin.", priority: "low", points: 100 },
    { title: "10-WUT GRAND THEFT: A guy who brought a stolen forklift into a convenience store is currently fleeing the scene after robbing the store of a jar of weaponized pickles. The item is heavier than it looks; suspect is currently dragging it at 1 mph.", priority: "low", points: 300 },
    { title: "10-99 THREAT TO LIFE: Suspect experiencing severe hallucinations from black-market focus pills is actively threatening pedestrians with a medieval morning star made from a disco ball and a mic stand. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills has already hospitalized three people using a medieval morning star made from a disco ball and a mic stand. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual who consumed 40 synthesized adrenaline pills is destroying a pharmacy waiting room with a medieval morning star made from a disco ball and a mic stand. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect high on illegal 'Neon-Sting' pills is demanding a helicopter while pointing a high-pressure hose spraying weaponized mayonnaise. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills has barricaded themselves in the local clinic and is assaulting staff using a high-pressure hose spraying weaponized mayonnaise. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 420 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills has barricaded themselves in the local clinic and is assaulting staff using a frozen tuna fish wrapped in barbed wire. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 666 },
    { title: "10-99 THREAT TO LIFE: An individual who consumed 40 synthesized adrenaline pills has already hospitalized three people using a tactical assault toaster that shoots flaming bread. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is demanding a helicopter while pointing a laser-guided toilet plunger. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements has barricaded themselves in the local clinic and is assaulting staff using a heavily modified tactical spatula. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills is destroying a pharmacy waiting room with a sharpened surfboard coated in synthetic poison. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A rogue pharmacist strung out on their own experimental pain pills has taken a vending machine hostage using a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills has already hospitalized three people using a tactical assault toaster that shoots flaming bread. Officers are requesting immediate backup and a very large net.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills has already hospitalized three people using a medieval morning star made from a disco ball and a mic stand. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 420 },
    { title: "10-41 AGGRAVATED ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills is threatening to 'reboot the simulation' using a tactical assault toaster that shoots flaming bread. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A suspect trying to rob a pharmacy for 'time-dilation' pills is screaming incoherently while swinging a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Officers are requesting immediate backup and a very large net.", priority: "high", points: 250 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills is actively threatening pedestrians with a frozen tuna fish wrapped in barbed wire. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints has barricaded themselves in the local clinic and is assaulting staff using a laser-guided toilet plunger. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is demanding a helicopter while pointing a sharpened surfboard coated in synthetic poison. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual who consumed 40 synthesized adrenaline pills is screaming incoherently while swinging a flamethrower fashioned from a leaf blower and a bottle of hot sauce. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is demanding a helicopter while pointing a sock filled with loose batteries and existential dread. The suspect claims the pills told them to do it.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: A man refusing to take his mandatory compliance pills is actively threatening pedestrians with a high-pressure hose spraying weaponized mayonnaise. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is chasing the precinct captain down the street wielding a sharpened surfboard coated in synthetic poison. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is threatening to 'reboot the simulation' using a live, extremely angry badger tied to a golf club. Officers are requesting immediate backup and a very large net.", priority: "high", points: 250 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is demanding a helicopter while pointing a sharpened surfboard coated in synthetic poison. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 420 },
    { title: "10-41 AGGRAVATED ASSAULT: A man refusing to take his mandatory compliance pills has taken a vending machine hostage using a sharpened surfboard coated in synthetic poison. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A suspect trying to rob a pharmacy for 'time-dilation' pills has barricaded themselves in the local clinic and is assaulting staff using a robotic arm holding a very sharp pair of safety scissors. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: An individual demanding a refund for counterfeit memory-wipe pills has taken a vending machine hostage using a frozen tuna fish wrapped in barbed wire. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 800 },
    { title: "10-99 THREAT TO LIFE: A rogue pharmacist strung out on their own experimental pain pills is actively threatening pedestrians with a guitar that shoots concentrated microwave radiation. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: A rogue pharmacist strung out on their own experimental pain pills has barricaded themselves in the local clinic and is assaulting staff using a frozen tuna fish wrapped in barbed wire. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A rogue pharmacist strung out on their own experimental pain pills is screaming incoherently while swinging a guitar that shoots concentrated microwave radiation. Officers are requesting immediate backup and a very large net.", priority: "high", points: 250 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills is destroying a pharmacy waiting room with a remote-controlled lawnmower strapped to their chest. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A rogue pharmacist strung out on their own experimental pain pills is engaging SWAT teams in close-quarters combat with a robotic arm holding a very sharp pair of safety scissors. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is destroying a pharmacy waiting room with a sock filled with loose batteries and existential dread. Officers are requesting immediate backup and a very large net.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A rogue pharmacist strung out on their own experimental pain pills is actively threatening pedestrians with a remote-controlled lawnmower strapped to their chest. The suspect claims the pills told them to do it.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills is actively threatening pedestrians with a weaponized baguette that has been left out to harden for 6 months. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: Someone aggressively defending a dumpster full of expired sleeping pills has taken a vending machine hostage using a robotic arm holding a very sharp pair of safety scissors. The suspect claims the pills told them to do it.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is threatening to 'reboot the simulation' using a frozen tuna fish wrapped in barbed wire. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: Suspect experiencing severe hallucinations from black-market focus pills is actively threatening pedestrians with a guitar that shoots concentrated microwave radiation. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: An individual who consumed 40 synthesized adrenaline pills has taken a vending machine hostage using a medieval morning star made from a disco ball and a mic stand. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is screaming incoherently while swinging a high-pressure hose spraying weaponized mayonnaise. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 800 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is actively threatening pedestrians with a remote-controlled lawnmower strapped to their chest. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills is destroying a pharmacy waiting room with a tactical assault toaster that shoots flaming bread. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is threatening to 'reboot the simulation' using a frozen tuna fish wrapped in barbed wire. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is actively threatening pedestrians with a high-pressure hose spraying weaponized mayonnaise. The suspect claims the pills told them to do it.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is chasing the precinct captain down the street wielding a robotic arm holding a very sharp pair of safety scissors. Officers are requesting immediate backup and a very large net.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: A rogue pharmacist strung out on their own experimental pain pills is screaming incoherently while swinging a robotic arm holding a very sharp pair of safety scissors. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: An individual demanding a refund for counterfeit memory-wipe pills is engaging SWAT teams in close-quarters combat with a heavily modified tactical spatula. Officers are requesting immediate backup and a very large net.", priority: "high", points: 250 },
    { title: "10-41 AGGRAVATED ASSAULT: A rogue pharmacist strung out on their own experimental pain pills is demanding a helicopter while pointing a sock filled with loose batteries and existential dread. Officers are requesting immediate backup and a very large net.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: Suspect vibrating violently after ingesting military-grade stimulant pills is actively threatening pedestrians with a heavily modified tactical spatula. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: Someone aggressively defending a dumpster full of expired sleeping pills is destroying a pharmacy waiting room with a sock filled with loose batteries and existential dread. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills is destroying a pharmacy waiting room with a robotic arm holding a very sharp pair of safety scissors. The suspect claims the pills told them to do it.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A rogue pharmacist strung out on their own experimental pain pills has already hospitalized three people using a sock filled with loose batteries and existential dread. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: A civilian who crushed and snorted illegal stamina pills is threatening to 'reboot the simulation' using a flamethrower fashioned from a leaf blower and a bottle of hot sauce. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 100 },
    { title: "10-WUT ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills is engaging SWAT teams in close-quarters combat with a remote-controlled lawnmower strapped to their chest. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements has already hospitalized three people using a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A suspect trying to rob a pharmacy for 'time-dilation' pills is screaming incoherently while swinging a heavily enchanted garden gnome. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: A civilian who crushed and snorted illegal stamina pills is actively threatening pedestrians with a live, extremely angry badger tied to a golf club. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: Suspect vibrating violently after ingesting military-grade stimulant pills is demanding a helicopter while pointing a chainsaw constructed entirely out of office staplers. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is threatening to 'reboot the simulation' using a laser-guided toilet plunger. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints has barricaded themselves in the local clinic and is assaulting staff using a tactical assault toaster that shoots flaming bread. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is demanding a helicopter while pointing a chainsaw constructed entirely out of office staplers. Officers are requesting immediate backup and a very large net.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints has already hospitalized three people using a heavily modified tactical spatula. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: Suspect experiencing severe hallucinations from black-market focus pills has already hospitalized three people using a heavily modified tactical spatula. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: A civilian who crushed and snorted illegal stamina pills has taken a vending machine hostage using a high-pressure hose spraying weaponized mayonnaise. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints has taken a vending machine hostage using a robotic arm holding a very sharp pair of safety scissors. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is actively threatening pedestrians with a guitar that shoots concentrated microwave radiation. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: Someone aggressively defending a dumpster full of expired sleeping pills is threatening to 'reboot the simulation' using a tactical assault toaster that shoots flaming bread. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 100 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills has taken a vending machine hostage using a guitar that shoots concentrated microwave radiation. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills has taken a vending machine hostage using a remote-controlled lawnmower strapped to their chest. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills has barricaded themselves in the local clinic and is assaulting staff using a pair of nunchucks made from synthetic adult toys. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 420 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is threatening to 'reboot the simulation' using a chainsaw constructed entirely out of office staplers. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: Suspect experiencing severe hallucinations from black-market focus pills is screaming incoherently while swinging a guitar that shoots concentrated microwave radiation. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills is actively threatening pedestrians with a medieval morning star made from a disco ball and a mic stand. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints is threatening to 'reboot the simulation' using a remote-controlled lawnmower strapped to their chest. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A suspect trying to rob a pharmacy for 'time-dilation' pills is threatening to 'reboot the simulation' using a high-pressure hose spraying weaponized mayonnaise. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A man refusing to take his mandatory compliance pills is threatening to 'reboot the simulation' using a chainsaw constructed entirely out of office staplers. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills has barricaded themselves in the local clinic and is assaulting staff using a robotic arm holding a very sharp pair of safety scissors. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is destroying a pharmacy waiting room with a weaponized baguette that has been left out to harden for 6 months. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills has barricaded themselves in the local clinic and is assaulting staff using a laser-guided toilet plunger. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A civilian who crushed and snorted illegal stamina pills is screaming incoherently while swinging a live, extremely angry badger tied to a golf club. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 250 },
    { title: "10-41 AGGRAVATED ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills is threatening to 'reboot the simulation' using a medieval morning star made from a disco ball and a mic stand. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is actively threatening pedestrians with a chainsaw constructed entirely out of office staplers. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills has taken a vending machine hostage using a flamethrower fashioned from a leaf blower and a bottle of hot sauce. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills is threatening to 'reboot the simulation' using a medieval morning star made from a disco ball and a mic stand. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: Suspect experiencing severe hallucinations from black-market focus pills is chasing the precinct captain down the street wielding a remote-controlled lawnmower strapped to their chest. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills has taken a vending machine hostage using a laser-guided toilet plunger. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is demanding a helicopter while pointing a robotic arm holding a very sharp pair of safety scissors. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is actively threatening pedestrians with a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: A civilian who crushed and snorted illegal stamina pills is chasing the precinct captain down the street wielding a pair of nunchucks made from synthetic adult toys. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is destroying a pharmacy waiting room with a remote-controlled lawnmower strapped to their chest. Officers are requesting immediate backup and a very large net.", priority: "high", points: 100 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills is demanding a helicopter while pointing a robotic arm holding a very sharp pair of safety scissors. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is demanding a helicopter while pointing a chainsaw constructed entirely out of office staplers. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is engaging SWAT teams in close-quarters combat with a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is actively threatening pedestrians with a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills has barricaded themselves in the local clinic and is assaulting staff using a guitar that shoots concentrated microwave radiation. The suspect claims the pills told them to do it.", priority: "high", points: 100 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is destroying a pharmacy waiting room with a sharpened surfboard coated in synthetic poison. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is screaming incoherently while swinging a flamethrower fashioned from a leaf blower and a bottle of hot sauce. The suspect claims the pills told them to do it.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints is destroying a pharmacy waiting room with a weaponized baguette that has been left out to harden for 6 months. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is demanding a helicopter while pointing a live, extremely angry badger tied to a golf club. The suspect claims the pills told them to do it.", priority: "high", points: 800 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints is actively threatening pedestrians with a heavily enchanted garden gnome. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills is demanding a helicopter while pointing a tactical assault toaster that shoots flaming bread. The suspect claims the pills told them to do it.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is destroying a pharmacy waiting room with a chainsaw constructed entirely out of office staplers. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is screaming incoherently while swinging a guitar that shoots concentrated microwave radiation. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: Someone aggressively defending a dumpster full of expired sleeping pills is screaming incoherently while swinging a remote-controlled lawnmower strapped to their chest. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: An individual demanding a refund for counterfeit memory-wipe pills is actively threatening pedestrians with a laser-guided toilet plunger. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A rogue pharmacist strung out on their own experimental pain pills has already hospitalized three people using a medieval morning star made from a disco ball and a mic stand. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 100 },
    { title: "10-WUT ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills has already hospitalized three people using a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 250 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect high on illegal 'Neon-Sting' pills is chasing the precinct captain down the street wielding a robotic arm holding a very sharp pair of safety scissors. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills is actively threatening pedestrians with a medieval morning star made from a disco ball and a mic stand. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual who consumed 40 synthesized adrenaline pills is demanding a helicopter while pointing a laser-guided toilet plunger. Officers are requesting immediate backup and a very large net.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: Someone aggressively defending a dumpster full of expired sleeping pills is destroying a pharmacy waiting room with a heavily modified tactical spatula. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is actively threatening pedestrians with a frozen tuna fish wrapped in barbed wire. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: Suspect experiencing severe hallucinations from black-market focus pills is demanding a helicopter while pointing a tactical assault toaster that shoots flaming bread. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills has barricaded themselves in the local clinic and is assaulting staff using a heavily enchanted garden gnome. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: A civilian who crushed and snorted illegal stamina pills is demanding a helicopter while pointing a robotic arm holding a very sharp pair of safety scissors. The suspect claims the pills told them to do it.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A suspect trying to rob a pharmacy for 'time-dilation' pills is demanding a helicopter while pointing a guitar that shoots concentrated microwave radiation. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is demanding a helicopter while pointing a heavily modified tactical spatula. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A rogue pharmacist strung out on their own experimental pain pills is threatening to 'reboot the simulation' using a laser-guided toilet plunger. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A civilian who crushed and snorted illegal stamina pills is destroying a pharmacy waiting room with a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 100 },
    { title: "10-WUT ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills is chasing the precinct captain down the street wielding a frozen tuna fish wrapped in barbed wire. Officers are requesting immediate backup and a very large net.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: A civilian who crushed and snorted illegal stamina pills is engaging SWAT teams in close-quarters combat with a tactical assault toaster that shoots flaming bread. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills has barricaded themselves in the local clinic and is assaulting staff using a laser-guided toilet plunger. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: An individual who consumed 40 synthesized adrenaline pills is chasing the precinct captain down the street wielding a heavily enchanted garden gnome. Officers are requesting immediate backup and a very large net.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is screaming incoherently while swinging a sock filled with loose batteries and existential dread. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A suspect trying to rob a pharmacy for 'time-dilation' pills has taken a vending machine hostage using a weaponized baguette that has been left out to harden for 6 months. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: Suspect vibrating violently after ingesting military-grade stimulant pills has taken a vending machine hostage using a sock filled with loose batteries and existential dread. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills has taken a vending machine hostage using a medieval morning star made from a disco ball and a mic stand. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills is screaming incoherently while swinging a heavily enchanted garden gnome. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is actively threatening pedestrians with a guitar that shoots concentrated microwave radiation. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is engaging SWAT teams in close-quarters combat with a high-pressure hose spraying weaponized mayonnaise. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: Suspect high on illegal 'Neon-Sting' pills is engaging SWAT teams in close-quarters combat with a heavily enchanted garden gnome. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills is screaming incoherently while swinging a laser-guided toilet plunger. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: A rogue pharmacist strung out on their own experimental pain pills is chasing the precinct captain down the street wielding a tactical assault toaster that shoots flaming bread. The suspect claims the pills told them to do it.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills is screaming incoherently while swinging a medieval morning star made from a disco ball and a mic stand. The suspect claims the pills told them to do it.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is chasing the precinct captain down the street wielding a frozen tuna fish wrapped in barbed wire. The suspect claims the pills told them to do it.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect high on illegal 'Neon-Sting' pills is threatening to 'reboot the simulation' using a robotic arm holding a very sharp pair of safety scissors. Officers are requesting immediate backup and a very large net.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: Suspect high on illegal 'Neon-Sting' pills is chasing the precinct captain down the street wielding a heavily enchanted garden gnome. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 420 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is engaging SWAT teams in close-quarters combat with a pair of nunchucks made from synthetic adult toys. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 666 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints has taken a vending machine hostage using a weaponized baguette that has been left out to harden for 6 months. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is screaming incoherently while swinging a heavily modified tactical spatula. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills is actively threatening pedestrians with a frozen tuna fish wrapped in barbed wire. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is destroying a pharmacy waiting room with a laser-guided toilet plunger. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A civilian who crushed and snorted illegal stamina pills is destroying a pharmacy waiting room with a heavily enchanted garden gnome. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 666 },
    { title: "10-99 THREAT TO LIFE: Suspect high on illegal 'Neon-Sting' pills is actively threatening pedestrians with a sock filled with loose batteries and existential dread. Officers are requesting immediate backup and a very large net.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is actively threatening pedestrians with a sharpened surfboard coated in synthetic poison. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is destroying a pharmacy waiting room with a pair of nunchucks made from synthetic adult toys. The suspect claims the pills told them to do it.", priority: "high", points: 250 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is destroying a pharmacy waiting room with a pair of nunchucks made from synthetic adult toys. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills is engaging SWAT teams in close-quarters combat with a sock filled with loose batteries and existential dread. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is engaging SWAT teams in close-quarters combat with a heavily enchanted garden gnome. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: Suspect experiencing severe hallucinations from black-market focus pills is engaging SWAT teams in close-quarters combat with a medieval morning star made from a disco ball and a mic stand. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual who consumed 40 synthesized adrenaline pills is engaging SWAT teams in close-quarters combat with a guitar that shoots concentrated microwave radiation. Officers are requesting immediate backup and a very large net.", priority: "high", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is chasing the precinct captain down the street wielding a laser-guided toilet plunger. Officers are requesting immediate backup and a very large net.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is actively threatening pedestrians with a pair of nunchucks made from synthetic adult toys. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A man refusing to take his mandatory compliance pills has taken a vending machine hostage using a live, extremely angry badger tied to a golf club. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A man refusing to take his mandatory compliance pills is screaming incoherently while swinging a remote-controlled lawnmower strapped to their chest. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is actively threatening pedestrians with a heavily modified tactical spatula. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: A civilian who crushed and snorted illegal stamina pills is engaging SWAT teams in close-quarters combat with a live, extremely angry badger tied to a golf club. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints is threatening to 'reboot the simulation' using a sock filled with loose batteries and existential dread. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 100 },
    { title: "10-99 THREAT TO LIFE: A civilian who crushed and snorted illegal stamina pills has already hospitalized three people using a frozen tuna fish wrapped in barbed wire. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is actively threatening pedestrians with a high-pressure hose spraying weaponized mayonnaise. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is chasing the precinct captain down the street wielding a frozen tuna fish wrapped in barbed wire. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills has taken a vending machine hostage using a sharpened surfboard coated in synthetic poison. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is threatening to 'reboot the simulation' using a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A man refusing to take his mandatory compliance pills is chasing the precinct captain down the street wielding a heavily enchanted garden gnome. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 666 },
    { title: "10-99 THREAT TO LIFE: Someone aggressively defending a dumpster full of expired sleeping pills is threatening to 'reboot the simulation' using a frozen tuna fish wrapped in barbed wire. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills has taken a vending machine hostage using a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is chasing the precinct captain down the street wielding a robotic arm holding a very sharp pair of safety scissors. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: A man refusing to take his mandatory compliance pills is chasing the precinct captain down the street wielding a guitar that shoots concentrated microwave radiation. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is engaging SWAT teams in close-quarters combat with a live, extremely angry badger tied to a golf club. The suspect claims the pills told them to do it.", priority: "high", points: 420 },
    { title: "10-41 AGGRAVATED ASSAULT: A rogue pharmacist strung out on their own experimental pain pills is destroying a pharmacy waiting room with a pair of nunchucks made from synthetic adult toys. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: Someone aggressively defending a dumpster full of expired sleeping pills is engaging SWAT teams in close-quarters combat with a medieval morning star made from a disco ball and a mic stand. Officers are requesting immediate backup and a very large net.", priority: "high", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills has already hospitalized three people using a chainsaw constructed entirely out of office staplers. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 800 },
    { title: "10-WUT ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills has taken a vending machine hostage using a medieval morning star made from a disco ball and a mic stand. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills is actively threatening pedestrians with a frozen tuna fish wrapped in barbed wire. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: A man refusing to take his mandatory compliance pills is chasing the precinct captain down the street wielding a flamethrower fashioned from a leaf blower and a bottle of hot sauce. Officers are requesting immediate backup and a very large net.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills is chasing the precinct captain down the street wielding a heavily modified tactical spatula. Officers are requesting immediate backup and a very large net.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect high on illegal 'Neon-Sting' pills is demanding a helicopter while pointing a guitar that shoots concentrated microwave radiation. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is demanding a helicopter while pointing a laser-guided toilet plunger. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 800 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints is actively threatening pedestrians with a weaponized baguette that has been left out to harden for 6 months. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 1000 },
    { title: "10-41 AGGRAVATED ASSAULT: A suspect trying to rob a pharmacy for 'time-dilation' pills is screaming incoherently while swinging a guitar that shoots concentrated microwave radiation. The suspect claims the pills told them to do it.", priority: "high", points: 420 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is screaming incoherently while swinging a guitar that shoots concentrated microwave radiation. Officers are requesting immediate backup and a very large net.", priority: "high", points: 420 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is chasing the precinct captain down the street wielding a chainsaw constructed entirely out of office staplers. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is engaging SWAT teams in close-quarters combat with a pair of nunchucks made from synthetic adult toys. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: A man refusing to take his mandatory compliance pills is chasing the precinct captain down the street wielding a heavily modified tactical spatula. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who mistook experimental hyper-aggression pills for breath mints is engaging SWAT teams in close-quarters combat with a guitar that shoots concentrated microwave radiation. The suspect claims the pills told them to do it.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is engaging SWAT teams in close-quarters combat with a heavily modified tactical spatula. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-99 THREAT TO LIFE: A suspect trying to rob a pharmacy for 'time-dilation' pills is destroying a pharmacy waiting room with a heavily modified tactical spatula. The weapon is emitting a loud, looping soundbite of a 90s sitcom laugh track.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills is destroying a pharmacy waiting room with a high-pressure hose spraying weaponized mayonnaise. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 666 },
    { title: "10-WUT ASSAULT: A rogue pharmacist strung out on their own experimental pain pills is threatening to 'reboot the simulation' using a pair of nunchucks made from synthetic adult toys. The suspect is completely naked except for a pair of tactical combat boots.", priority: "high", points: 1000 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints is demanding a helicopter while pointing a weaponized baguette that has been left out to harden for 6 months. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 666 },
    { title: "10-99 THREAT TO LIFE: A citizen who mistook experimental hyper-aggression pills for breath mints is engaging SWAT teams in close-quarters combat with a medieval morning star made from a disco ball and a mic stand. The suspect claims the pills told them to do it.", priority: "high", points: 55 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills is destroying a pharmacy waiting room with a medieval morning star made from a disco ball and a mic stand. Officers are advised that the weapon appears to be surprisingly effective.", priority: "high", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements has barricaded themselves in the local clinic and is assaulting staff using a heavily enchanted garden gnome. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 1000 },
    { title: "10-WUT ASSAULT: A citizen who swallowed an entire bottle of 'Cyber-Rage' supplements is demanding a helicopter while pointing a frozen tuna fish wrapped in barbed wire. The suspect is foaming at the mouth in bright neon colors.", priority: "high", points: 666 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect experiencing severe hallucinations from black-market focus pills has taken a vending machine hostage using a high-pressure hose spraying weaponized mayonnaise. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 55 },
    { title: "10-WUT ASSAULT: Someone aggressively defending a dumpster full of expired sleeping pills is actively threatening pedestrians with a guitar that shoots concentrated microwave radiation. The suspect claims the pills told them to do it.", priority: "high", points: 800 },
    { title: "10-41 AGGRAVATED ASSAULT: An individual demanding a refund for counterfeit memory-wipe pills has barricaded themselves in the local clinic and is assaulting staff using a live, extremely angry badger tied to a golf club. Suspect is moving at incredibly high speeds due to the pills.", priority: "high", points: 250 },
    { title: "10-WUT ASSAULT: An individual who consumed 40 synthesized adrenaline pills has already hospitalized three people using a robotic arm holding a very sharp pair of safety scissors. Suspect is demanding a specific brand of sparkling water before surrendering.", priority: "high", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: Suspect vibrating violently after ingesting military-grade stimulant pills is actively threatening pedestrians with a guitar that shoots concentrated microwave radiation. The pills have seemingly granted the suspect temporary immunity to taser fire.", priority: "high", points: 250 },
    { title: "10-99 THREAT TO LIFE: A man refusing to take his mandatory compliance pills is chasing the precinct captain down the street wielding a tactical assault toaster that shoots flaming bread. Civilian casualties are high, mostly due to sheer confusion.", priority: "high", points: 55 },
    { title: "10-WUT: A half-giant riding a flying motorcycle is attempting to breach the municipal blast doors by repeatedly yelling 'Alohomora'. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 9 },
    { title: "10-WUT: An elderly man with a massive white beard is selling unauthorized 'love potions' that are clearly just toxic battery fluid. Suspect claims their invisibility cloak is in the wash.", priority: "low", points: 934 },
    { title: "10-WUT: A citizen demanding to know the location of Platform 9 3/4 is trying to play Quidditch by throwing heavy metal spheres at passing hover-cars. The suspect keeps trying to apparate away but just violently spasms in place.", priority: "low", points: 150 },
    { title: "10-WUT: A citizen demanding to know the location of Platform 9 3/4 is shooting green sparks at police drones and screaming 'Avada Kedavra!' Civilian bystanders are throwing pocket change at them like a street performer.", priority: "low", points: 420 },
    { title: "10-WUT: A suspect claiming they escaped from Azkaban Prison is trying to command a flock of cyber-pigeons to deliver 'Howler' letters. Civilian bystanders are throwing pocket change at them like a street performer.", priority: "low", points: 150 },
    { title: "10-WUT: A woman aggressively waving a glowing wand is attempting to breach the municipal blast doors by repeatedly yelling 'Alohomora'. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 934 },
    { title: "10-WUT: An elderly man with a massive white beard is attempting to use Floo Powder in a burning trash can to fast-travel. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 934 },
    { title: "10-WUT: An elderly man with a massive white beard is searching for Horcruxes in the city dump. The suspect is demanding to speak to the 'Minister of Magic'.", priority: "low", points: 9 },
    { title: "10-WUT: A woman aggressively waving a glowing wand is trying to play Quidditch by throwing heavy metal spheres at passing hover-cars. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 934 },
    { title: "10-WUT: A rogue citizen on a modified flying push-broom is searching for Horcruxes in the city dump. Officers report the suspect is genuinely surprised when the magic doesn't work.", priority: "low", points: 777 },
    { title: "10-WUT: An elderly man with a massive white beard is shooting green sparks at police drones and screaming 'Avada Kedavra!' The suspect keeps trying to apparate away but just violently spasms in place.", priority: "low", points: 9 },
    { title: "10-WUT: A group of teenagers claiming to be from 'House Slytherin' is attempting to breach the municipal blast doors by repeatedly yelling 'Alohomora'. The suspect is demanding to speak to the 'Minister of Magic'.", priority: "low", points: 9 },
    { title: "10-WUT: A citizen demanding to know the location of Platform 9 3/4 is demanding that bystanders hand over their 'galleons' or be cursed. The suspect keeps trying to apparate away but just violently spasms in place.", priority: "low", points: 420 },
    { title: "10-WUT: A citizen demanding to know the location of Platform 9 3/4 is accusing the arresting officers of being 'filthy Muggles'. The suspect is demanding to speak to the 'Minister of Magic'.", priority: "low", points: 934 },
    { title: "10-WUT: An elderly man with a massive white beard is accusing the arresting officers of being 'filthy Muggles'. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 777 },
    { title: "10-WUT: A citizen demanding to know the location of Platform 9 3/4 is attempting to breach the municipal blast doors by repeatedly yelling 'Alohomora'. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 150 },
    { title: "10-WUT: Someone dressed as a giant sorting hat is trying to brew Polyjuice Potion in the street using motor oil and cyber-kibble. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 777 },
    { title: "10-WUT: A group of teenagers claiming to be from 'House Slytherin' is accusing the arresting officers of being 'filthy Muggles'. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 9 },
    { title: "10-WUT: A suspect claiming they escaped from Azkaban Prison is attempting to turn a police cruiser into a teacup with a flick of their wrist. Suspect claims their invisibility cloak is in the wash.", priority: "low", points: 9 },
    { title: "10-WUT: A woman aggressively waving a glowing wand is claiming the Chief of Police is actually a Death Eater in disguise. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 9 },
    { title: "10-WUT: Someone dressed as a giant sorting hat is attempting to use Floo Powder in a burning trash can to fast-travel. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 777 },
    { title: "10-WUT: A half-giant riding a flying motorcycle is trying to cast a Patronus charm to ward off a swarm of angry delivery drones. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 420 },
    { title: "10-WUT: A suspect in tattered robes wielding a wooden stick is searching for Horcruxes in the city dump. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 934 },
    { title: "10-WUT: A rogue citizen on a modified flying push-broom is demanding that bystanders hand over their 'galleons' or be cursed. The situation is escalating because the suspect refuses to lower their wand.", priority: "low", points: 934 },
    { title: "10-WUT: A suspect claiming they escaped from Azkaban Prison is complaining that their wand is broken after trying to parry a taser. The situation is escalating because the suspect refuses to lower their wand.", priority: "low", points: 777 },
    { title: "10-WUT: An elderly man with a massive white beard is attempting to breach the municipal blast doors by repeatedly yelling 'Alohomora'. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 150 },
    { title: "10-WUT: A half-giant riding a flying motorcycle is attempting to use Floo Powder in a burning trash can to fast-travel. The suspect keeps trying to apparate away but just violently spasms in place.", priority: "low", points: 934 },
    { title: "10-WUT: A group of teenagers claiming to be from 'House Slytherin' is flying erratically through downtown traffic on a broomstick. Officers report the suspect is genuinely surprised when the magic doesn't work.", priority: "low", points: 9 },
    { title: "10-WUT: A suspect claiming they escaped from Azkaban Prison is accusing the arresting officers of being 'filthy Muggles'. The suspect keeps trying to apparate away but just violently spasms in place.", priority: "low", points: 934 },
    { title: "10-WUT: A rogue citizen on a modified flying push-broom is attempting to turn a police cruiser into a teacup with a flick of their wrist. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 777 },
    { title: "10-WUT: A suspect in tattered robes wielding a wooden stick is flying erratically through downtown traffic on a broomstick. Suspect is offering to trade a golden snitch for a reduced sentence.", priority: "low", points: 150 },
    { title: "10-WUT: A pale individual with no nose calling himself 'The Dark Lord' is trying to cast a Patronus charm to ward off a swarm of angry delivery drones. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 934 },
    { title: "10-WUT: Someone dressed as a giant sorting hat is trying to play Quidditch by throwing heavy metal spheres at passing hover-cars. The suspect is demanding to speak to the 'Minister of Magic'.", priority: "low", points: 777 },
    { title: "10-WUT: A pale individual with no nose calling himself 'The Dark Lord' is claiming the Chief of Police is actually a Death Eater in disguise. The suspect keeps trying to apparate away but just violently spasms in place.", priority: "low", points: 934 },
    { title: "10-WUT: A pale individual with no nose calling himself 'The Dark Lord' is trying to play Quidditch by throwing heavy metal spheres at passing hover-cars. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 420 },
    { title: "10-WUT: A pale individual with no nose calling himself 'The Dark Lord' is complaining that their wand is broken after trying to parry a taser. The suspect is demanding to speak to the 'Minister of Magic'.", priority: "low", points: 420 },
    { title: "10-WUT: A suspect in tattered robes wielding a wooden stick is flying erratically through downtown traffic on a broomstick. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 150 },
    { title: "10-WUT: A group of teenagers claiming to be from 'House Slytherin' is attempting to use Floo Powder in a burning trash can to fast-travel. Officers report the suspect is genuinely surprised when the magic doesn't work.", priority: "low", points: 777 },
    { title: "10-WUT: A pale individual with no nose calling himself 'The Dark Lord' is trying to play Quidditch by throwing heavy metal spheres at passing hover-cars. The suspect is demanding to speak to the 'Minister of Magic'.", priority: "low", points: 9 },
    { title: "10-WUT: A woman aggressively waving a glowing wand is claiming the Chief of Police is actually a Death Eater in disguise. Officers report the suspect is genuinely surprised when the magic doesn't work.", priority: "low", points: 777 },
    { title: "10-WUT: A pale individual with no nose calling himself 'The Dark Lord' is trying to command a flock of cyber-pigeons to deliver 'Howler' letters. Officers report the suspect is genuinely surprised when the magic doesn't work.", priority: "low", points: 420 },
    { title: "10-WUT: A rogue citizen on a modified flying push-broom is trying to brew Polyjuice Potion in the street using motor oil and cyber-kibble. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 777 },
    { title: "10-WUT: A group of teenagers claiming to be from 'House Slytherin' is attempting to breach the municipal blast doors by repeatedly yelling 'Alohomora'. Civilian bystanders are throwing pocket change at them like a street performer.", priority: "low", points: 9 },
    { title: "10-WUT: A woman aggressively waving a glowing wand is complaining that their wand is broken after trying to parry a taser. The suspect is demanding to speak to the 'Minister of Magic'.", priority: "low", points: 420 },
    { title: "10-WUT: A pale individual with no nose calling himself 'The Dark Lord' is attempting to breach the municipal blast doors by repeatedly yelling 'Alohomora'. Civilian bystanders are throwing pocket change at them like a street performer.", priority: "low", points: 777 },
    { title: "10-WUT: A group of teenagers claiming to be from 'House Slytherin' is shooting green sparks at police drones and screaming 'Avada Kedavra!' Suspect claims their invisibility cloak is in the wash.", priority: "low", points: 934 },
    { title: "10-WUT: Someone dressed as a giant sorting hat is complaining that their wand is broken after trying to parry a taser. The situation is escalating because the suspect refuses to lower their wand.", priority: "low", points: 777 },
    { title: "10-WUT: A suspect in tattered robes wielding a wooden stick is claiming the Chief of Police is actually a Death Eater in disguise. Officers are requesting backup from the 'Auror Department'.", priority: "low", points: 777 },
    { title: "10-WUT: A half-giant riding a flying motorcycle is trying to command a flock of cyber-pigeons to deliver 'Howler' letters. Officers report the suspect is genuinely surprised when the magic doesn't work.", priority: "low", points: 150 },
    { title: "10-WUT: Someone dressed as a giant sorting hat is claiming the Chief of Police is actually a Death Eater in disguise. Suspect claims their invisibility cloak is in the wash.", priority: "low", points: 9 },
    { title: "10-99 ANOMALY: Space shuttle detected landed in unauthorized location Block 45. Suspect inside is broadcasting unusual, heavy breathing over local comms.", priority: "high", points: 61563 },
    ...
    { title: "10-WUT: An extremely dehydrated marathon runner is licking the sidewalk to 'check for structural integrity'. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 10 },
    { title: "10-WUT: An elderly woman with a step ladder is climbing telephone poles to lick the high-voltage wires. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 30 },
    { title: "10-WUT: An extremely dehydrated marathon runner is aggressively licking the doorknobs of the municipal bank. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 50 },
    { title: "10-WUT: An elderly woman with a step ladder is aggressively licking all the stop signs at the intersection. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 30 },
    { title: "10-WUT: A group of synchronized teenagers is attempting to lick the third rail of the transit system. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 20 },
    { title: "10-WUT: A rogue sanitation worker is trying to lick the static electricity off of old televisions. The suspect claims they are 'absorbing the city's flavor data'.", priority: "low", points: 30 },
    { title: "10-WUT: A local politician is running down the street trying to lick the faces of statues. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 20 },
    { title: "10-WUT: Suspicious individual is licking the barcode scanners at the grocery store checkout. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 100 },
    { title: "10-WUT: A local politician is aggressively licking the doorknobs of the municipal bank. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 50 },
    { title: "10-WUT: A person wearing a 'Lick Police' badge is aggressively licking the doorknobs of the municipal bank. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 20 },
    { title: "10-WUT: An elderly woman with a step ladder is offering $5 to anyone who will let them lick their shoes. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 50 },
    { title: "10-WUT: A suspect on unknown hallucinogens is running down the street trying to lick the faces of statues. Suspect claims it is a vital part of their new diet.", priority: "low", points: 50 },
    { title: "10-WUT: A man dressed as a giant human tongue is climbing telephone poles to lick the high-voltage wires. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 50 },
    { title: "10-WUT: A man dressed as a giant human tongue is running down the street trying to lick the faces of statues. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 30 },
    { title: "10-WUT: An extremely dehydrated marathon runner is licking the sidewalk to 'check for structural integrity'. Suspect claims it is a vital part of their new diet.", priority: "low", points: 10 },
    { title: "10-WUT: A suspect on unknown hallucinogens is licking the boots of the riot control mechs. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 30 },
    { title: "10-WUT: A man dressed as a giant human tongue is attempting to lick the third rail of the transit system. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 69 },
    { title: "10-WUT: A cybernetically enhanced dog is climbing telephone poles to lick the high-voltage wires. Suspect claims it is a vital part of their new diet.", priority: "low", points: 69 },
    { title: "10-WUT: Someone claiming to be a 'taste tester for the matrix' is climbing telephone poles to lick the high-voltage wires. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 100 },
    { title: "10-WUT: A guy in a hazmat suit is climbing telephone poles to lick the high-voltage wires. Suspect's tongue appears to be fully prehensile and 3 feet long.", priority: "low", points: 100 },
    { title: "10-WUT: Someone claiming to be a 'taste tester for the matrix' is trying to lick the exhaust pipe of a running hover-bus. The suspect is rating each lick out of 10 on a clipboard.", priority: "low", points: 100 },
    { title: "10-WUT: A rogue sanitation worker is licking a fire hydrant and is now permanently frozen to it. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 30 },
    { title: "10-WUT: A cybernetically enhanced dog is licking the radioactive waste barrels behind the science facility. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 100 },
    { title: "10-WUT: A rogue sanitation worker is trying to lick the exhaust pipe of a running hover-bus. Officers report the suspect's tongue is glowing in the dark.", priority: "low", points: 100 },
    { title: "10-WUT: Suspicious individual is trying to lick the exhaust pipe of a running hover-bus. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 69 },
    { title: "10-WUT: A cybernetically enhanced dog is licking the boots of the riot control mechs. The suspect is rating each lick out of 10 on a clipboard.", priority: "low", points: 30 },
    { title: "10-WUT: A cybernetically enhanced dog is licking a fire hydrant and is now permanently frozen to it. The suspect claims they are 'absorbing the city's flavor data'.", priority: "low", points: 50 },
    { title: "10-WUT: A person wearing a 'Lick Police' badge is aggressively licking all the stop signs at the intersection. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 69 },
    { title: "10-WUT: A rogue sanitation worker is aggressively licking all the stop signs at the intersection. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 20 },
    { title: "10-WUT: A guy in a hazmat suit is licking the sidewalk to 'check for structural integrity'. Officers report the suspect's tongue is glowing in the dark.", priority: "low", points: 20 },
    { title: "10-WUT: A local politician is licking a fire hydrant and is now permanently frozen to it. Officers are confused because the suspect is using a specialized 'licking attachment'.", priority: "low", points: 10 },
    { title: "10-WUT: A local politician is attempting to lick the third rail of the transit system. Suspect's tongue appears to be fully prehensile and 3 feet long.", priority: "low", points: 20 },
    { title: "10-WUT: An extremely dehydrated marathon runner is running down the street trying to lick the faces of statues. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 50 },
    { title: "10-WUT: A rogue sanitation worker is running down the street trying to lick the faces of statues. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 20 },
    { title: "10-WUT: A person wearing a 'Lick Police' badge is climbing telephone poles to lick the high-voltage wires. Officers are confused because the suspect is using a specialized 'licking attachment'.", priority: "low", points: 50 },
    { title: "10-WUT: A man dressed as a giant human tongue is slowly and methodically licking the windows of parked police cruisers. Suspect's tongue appears to be fully prehensile and 3 feet long.", priority: "low", points: 10 },
    { title: "10-WUT: Someone claiming to be a 'taste tester for the matrix' is slowly and methodically licking the windows of parked police cruisers. Officers report the suspect's tongue is glowing in the dark.", priority: "low", points: 69 },
    { title: "10-WUT: An extremely dehydrated marathon runner is licking the radioactive waste barrels behind the science facility. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 20 },
    { title: "10-WUT: A man dressed as a giant human tongue is aggressively licking the doorknobs of the municipal bank. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 69 },
    { title: "10-WUT: Someone claiming to be a 'taste tester for the matrix' is aggressively licking the doorknobs of the municipal bank. The suspect claims they are 'absorbing the city's flavor data'.", priority: "low", points: 100 },
    { title: "10-WUT: An extremely dehydrated marathon runner is climbing telephone poles to lick the high-voltage wires. Suspect claims it is a vital part of their new diet.", priority: "low", points: 30 },
    { title: "10-WUT: Suspicious individual is attempting to lick the third rail of the transit system. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 20 },
    { title: "10-WUT: Someone claiming to be a 'taste tester for the matrix' is offering $5 to anyone who will let them lick their shoes. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 10 },
    { title: "10-WUT: A suspect on unknown hallucinogens is licking the sidewalk to 'check for structural integrity'. Suspect claims it is a vital part of their new diet.", priority: "low", points: 50 },
    { title: "10-WUT: A man dressed as a giant human tongue is attempting to lick every single brick on the precinct wall. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 10 },
    { title: "10-WUT: A guy in a hazmat suit is trying to lick the static electricity off of old televisions. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 10 },
    { title: "10-WUT: A suspect on unknown hallucinogens is aggressively licking all the stop signs at the intersection. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 20 },
    { title: "10-WUT: An extremely dehydrated marathon runner is attempting to lick the third rail of the transit system. Suspect's tongue appears to be fully prehensile and 3 feet long.", priority: "low", points: 10 },
    { title: "10-WUT: Someone claiming to be a 'taste tester for the matrix' is climbing telephone poles to lick the high-voltage wires. Officers report the suspect's tongue is glowing in the dark.", priority: "low", points: 20 },
    { title: "10-WUT: A man dressed as a giant human tongue is climbing telephone poles to lick the high-voltage wires. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 30 },
    { title: "10-WUT: Suspicious individual is licking the sidewalk to 'check for structural integrity'. The suspect claims they are 'absorbing the city's flavor data'.", priority: "low", points: 20 },
    { title: "10-WUT: Someone claiming to be a 'taste tester for the matrix' is attempting to lick every single brick on the precinct wall. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 20 },
    { title: "10-WUT: Suspicious individual is attempting to lick the third rail of the transit system. Suspect claims it is a vital part of their new diet.", priority: "low", points: 50 },
    { title: "10-WUT: A guy in a hazmat suit is licking the barcode scanners at the grocery store checkout. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 69 },
    { title: "10-WUT: An elderly woman with a step ladder is running down the street trying to lick the faces of statues. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 69 },
    { title: "10-WUT: A rogue sanitation worker is running down the street trying to lick the faces of statues. Officers are confused because the suspect is using a specialized 'licking attachment'.", priority: "low", points: 20 },
    { title: "10-WUT: A man dressed as a giant human tongue is licking the boots of the riot control mechs. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 69 },
    { title: "10-WUT: A local politician is aggressively licking the doorknobs of the municipal bank. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 50 },
    { title: "10-WUT: A man dressed as a giant human tongue is aggressively licking the doorknobs of the municipal bank. Officers report the suspect's tongue is glowing in the dark.", priority: "low", points: 50 },
    { title: "10-WUT: A suspect on unknown hallucinogens is slowly and methodically licking the windows of parked police cruisers. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 30 },
    { title: "10-WUT: A rogue sanitation worker is attempting to lick the third rail of the transit system. The suspect is rating each lick out of 10 on a clipboard.", priority: "low", points: 30 },
    { title: "10-WUT: A guy in a hazmat suit is trying to lick the static electricity off of old televisions. Officers are confused because the suspect is using a specialized 'licking attachment'.", priority: "low", points: 20 },
    { title: "10-WUT: A man dressed as a giant human tongue is attempting to lick every single brick on the precinct wall. The suspect is rating each lick out of 10 on a clipboard.", priority: "low", points: 69 },
    { title: "10-WUT: An elderly woman with a step ladder is attempting to lick the third rail of the transit system. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 50 },
    { title: "10-WUT: A suspect on unknown hallucinogens is trying to lick the static electricity off of old televisions. Suspect claims it is a vital part of their new diet.", priority: "low", points: 69 },
    { title: "10-WUT: An extremely dehydrated marathon runner is climbing telephone poles to lick the high-voltage wires. The suspect claims they are 'absorbing the city's flavor data'.", priority: "low", points: 10 },
    { title: "10-WUT: A cybernetically enhanced dog is trying to lick the static electricity off of old televisions. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 20 },
    { title: "10-WUT: A group of synchronized teenagers is slowly and methodically licking the windows of parked police cruisers. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 50 },
    { title: "10-WUT: A man dressed as a giant human tongue is slowly and methodically licking the windows of parked police cruisers. Suspect claims it is a vital part of their new diet.", priority: "low", points: 30 },
    { title: "10-WUT: A person wearing a 'Lick Police' badge is aggressively licking the doorknobs of the municipal bank. The suspect is rating each lick out of 10 on a clipboard.", priority: "low", points: 100 },
    { title: "10-WUT: A rogue sanitation worker is slowly and methodically licking the windows of parked police cruisers. Officers are confused because the suspect is using a specialized 'licking attachment'.", priority: "low", points: 100 },
    { title: "10-WUT: An elderly woman with a step ladder is running down the street trying to lick the faces of statues. Suspect's tongue appears to be fully prehensile and 3 feet long.", priority: "low", points: 100 },
    { title: "10-WUT: An extremely dehydrated marathon runner is slowly and methodically licking the windows of parked police cruisers. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 50 },
    { title: "10-WUT: A cybernetically enhanced dog is aggressively licking the doorknobs of the municipal bank. Officers are requesting a hazmat team for immediate tongue decontamination.", priority: "low", points: 10 },
    { title: "10-WUT: An extremely dehydrated marathon runner is licking the radioactive waste barrels behind the science facility. Suspect claims it is a vital part of their new diet.", priority: "low", points: 50 },
    { title: "10-WUT: A man dressed as a giant human tongue is attempting to lick every single brick on the precinct wall. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 69 },
    { title: "10-WUT: A rogue sanitation worker is aggressively licking the doorknobs of the municipal bank. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 100 },
    { title: "10-WUT: A local politician is aggressively licking the doorknobs of the municipal bank. The suspect's tongue is currently stuck to a frozen metal pole.", priority: "low", points: 69 },
    { title: "10-WUT: A cybernetically enhanced dog is aggressively licking all the stop signs at the intersection. The suspect claims they are 'absorbing the city's flavor data'.", priority: "low", points: 20 },
    { title: "10-WUT: A man dressed as a giant human tongue is trying to lick the static electricity off of old televisions. Civilian bystanders are deeply uncomfortable but cannot look away.", priority: "low", points: 50 },
    { title: "10-WUT: An elderly woman with a step ladder is aggressively licking all the stop signs at the intersection. Suspect claims it is a vital part of their new diet.", priority: "low", points: 20 },
    { title: "10-WUT: A rogue sanitation worker is aggressively licking the doorknobs of the municipal bank. Suspect's tongue appears to be fully prehensile and 3 feet long.", priority: "low", points: 50 },
    { title: "10-WUT: A local politician is running down the street trying to lick the faces of statues. Suspect is demanding salt and pepper before continuing.", priority: "low", points: 69 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is demanding a trial by combat against a stop sign. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 7 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is attempting to mathematically prove that Tuesday doesn't exist. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 333 },
    { title: "10-WUT: An interdimensional pizza delivery guy is demanding a trial by combat against a stop sign. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 42 },
    { title: "10-WUT: A floating pair of neon green trousers is trying to legally adopt a 2004 Honda Civic. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 77 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is attempting to arrest the concept of gravity. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 95849 },
    { title: "10-WUT: A cloud of aggressive cotton candy is trying to deep-fry the entire municipal water supply. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 99 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is trying to legally adopt a 2004 Honda Civic. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 7 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is trying to deep-fry the entire municipal water supply. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 42 },
    { title: "10-WUT: A sentient pile of laundry is trying to reverse-engineer a slice of pepperoni pizza. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 42 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is attempting to arrest the concept of gravity. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 13 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is painting the air neon pink with sheer force of will. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 7 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is throwing invisible cheese at passing pedestrians. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 333 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is holding a puddle of water hostage for a ransom of dry ice. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 13 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is demanding that the sun turn down its brightness settings. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 7 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is trying to reverse-engineer a slice of pepperoni pizza. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 13 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is attempting to arrest the concept of gravity. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 77 },
    { title: "10-WUT: A flock of cybernetic pigeons is trying to reverse-engineer a slice of pepperoni pizza. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 333 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is trying to legally adopt a 2004 Honda Civic. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 13 },
    { title: "10-WUT: An interdimensional pizza delivery guy is demanding to speak to the CEO of Earth. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 42 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is trying to unionize the local wildlife. The suspect is currently vibrating at a frequency that makes them invisible to left-handed people.", priority: "low", points: 1 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is aggressively translating dog barks into dial-up modem sounds. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 888 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is aggressively translating dog barks into dial-up modem sounds. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 26612 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is attempting to arrest the concept of gravity. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 888 },
    { title: "10-WUT: A man made entirely of expired coupons is trying to reverse-engineer a slice of pepperoni pizza. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 1 },
    { title: "10-WUT: A flock of cybernetic pigeons is throwing invisible cheese at passing pedestrians. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 99 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is throwing invisible cheese at passing pedestrians. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 99 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is loudly arguing with their own shadow about tax evasion. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 42 },
    { title: "10-WUT: A herd of sentient roombas is demanding to speak to the CEO of Earth. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 13 },
    { title: "10-WUT: A floating pair of neon green trousers is trying to legally adopt a 2004 Honda Civic. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 333 },
    { title: "10-WUT: A man made entirely of expired coupons is aggressively translating dog barks into dial-up modem sounds. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 333 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is holding a puddle of water hostage for a ransom of dry ice. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 888 },
    { title: "10-WUT: A flock of cybernetic pigeons is attempting to arrest the concept of gravity. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 77 },
    { title: "10-WUT: A herd of sentient roombas is trying to download a car using a ham sandwich. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 42 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is trying to download a car using a ham sandwich. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 13 },
    { title: "10-WUT: A man made entirely of expired coupons is attempting to mathematically prove that Tuesday doesn't exist. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 99 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is aggressively translating dog barks into dial-up modem sounds. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 77 },
    { title: "10-WUT: A man made entirely of expired coupons is trying to parallel park a horse. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 333 },
    { title: "10-WUT: A flock of cybernetic pigeons is holding a puddle of water hostage for a ransom of dry ice. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 333 },
    { title: "10-WUT: An interdimensional pizza delivery guy is trying to parallel park a horse. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 99 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is painting the air neon pink with sheer force of will. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 7 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is demanding to speak to the CEO of Earth. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 28780 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is demanding that the sun turn down its brightness settings. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 888 },
    { title: "10-WUT: A floating pair of neon green trousers is challenging a fire hydrant to a staring contest. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 42 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is trying to reverse-engineer a slice of pepperoni pizza. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 77 },
    { title: "10-WUT: A herd of sentient roombas is throwing invisible cheese at passing pedestrians. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 42 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is aggressively translating dog barks into dial-up modem sounds. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 7 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is demanding a trial by combat against a stop sign. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 99 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is demanding a trial by combat against a stop sign. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 99 },
    { title: "10-WUT: A man made entirely of expired coupons is trying to parallel park a horse. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 888 },
    { title: "10-WUT: A floating pair of neon green trousers is attempting to mathematically prove that Tuesday doesn't exist. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 13 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is attempting to mathematically prove that Tuesday doesn't exist. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 13 },
    { title: "10-WUT: A cloud of aggressive cotton candy is demanding a trial by combat against a stop sign. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 77 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is demanding that the sun turn down its brightness settings. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 99 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is demanding to speak to the CEO of Earth. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 1 },
    { title: "10-WUT: A sentient pile of laundry is loudly arguing with their own shadow about tax evasion. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 77 },
    { title: "10-WUT: A sentient pile of laundry is trying to reverse-engineer a slice of pepperoni pizza. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 13 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is trying to reverse-engineer a slice of pepperoni pizza. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 13 },
    { title: "10-WUT: A cloud of aggressive cotton candy is attempting to arrest the concept of gravity. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 333 },
    { title: "10-WUT: A sentient pile of laundry is holding a puddle of water hostage for a ransom of dry ice. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 1 },
    { title: "10-WUT: A floating pair of neon green trousers is trying to parallel park a horse. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 12370 },
    { title: "10-WUT: An interdimensional pizza delivery guy is holding a puddle of water hostage for a ransom of dry ice. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 13 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is demanding that the sun turn down its brightness settings. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 1 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is demanding that the sun turn down its brightness settings. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 42 },
    { title: "10-WUT: A cloud of aggressive cotton candy is demanding that the sun turn down its brightness settings. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 333 },
    { title: "10-WUT: A sentient pile of laundry is trying to parallel park a horse. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 77 },
    { title: "10-WUT: An interdimensional pizza delivery guy is trying to parallel park a horse. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 77 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is trying to deep-fry the entire municipal water supply. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 13 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is demanding to speak to the CEO of Earth. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 99 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is demanding to speak to the CEO of Earth. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 77 },
    { title: "10-WUT: A floating pair of neon green trousers is demanding a trial by combat against a stop sign. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 333 },
    { title: "10-WUT: A sentient pile of laundry is demanding a trial by combat against a stop sign. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 77 },
    { title: "10-WUT: A floating pair of neon green trousers is challenging a fire hydrant to a staring contest. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 7 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is trying to legally adopt a 2004 Honda Civic. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 42 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is demanding a trial by combat against a stop sign. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 7 },
    { title: "10-WUT: A herd of sentient roombas is demanding that the sun turn down its brightness settings. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 888 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is demanding to speak to the CEO of Earth. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 23935 },
    { title: "10-WUT: A herd of sentient roombas is loudly arguing with their own shadow about tax evasion. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 77 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is aggressively translating dog barks into dial-up modem sounds. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 333 },
    { title: "10-WUT: A flock of cybernetic pigeons is attempting to mathematically prove that Tuesday doesn't exist. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 42 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is attempting to mathematically prove that Tuesday doesn't exist. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 99 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is attempting to mathematically prove that Tuesday doesn't exist. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 42 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is attempting to mathematically prove that Tuesday doesn't exist. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 333 },
    { title: "10-WUT: A floating pair of neon green trousers is attempting to mathematically prove that Tuesday doesn't exist. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 1 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is challenging a fire hydrant to a staring contest. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 54889 },
    { title: "10-WUT: A man made entirely of expired coupons is aggressively translating dog barks into dial-up modem sounds. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 1 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is trying to legally adopt a 2004 Honda Civic. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 99 },
    { title: "10-WUT: A cloud of aggressive cotton candy is loudly arguing with their own shadow about tax evasion. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 54879 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is trying to download a car using a ham sandwich. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 333 },
    { title: "10-WUT: A herd of sentient roombas is attempting to mathematically prove that Tuesday doesn't exist. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 333 },
    { title: "10-WUT: A sentient pile of laundry is throwing invisible cheese at passing pedestrians. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 81619 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is attempting to mathematically prove that Tuesday doesn't exist. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 1 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is challenging a fire hydrant to a staring contest. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 42 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is trying to parallel park a horse. The suspect is currently vibrating at a frequency that makes them invisible to left-handed people.", priority: "low", points: 888 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is demanding to speak to the CEO of Earth. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 7 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is trying to parallel park a horse. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 333 },
    { title: "10-WUT: An interdimensional pizza delivery guy is demanding a trial by combat against a stop sign. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 333 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is demanding to speak to the CEO of Earth. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 7 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is demanding to speak to the CEO of Earth. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 333 },
    { title: "10-WUT: A sentient pile of laundry is attempting to mathematically prove that Tuesday doesn't exist. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 99 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is demanding that the sun turn down its brightness settings. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 13 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is loudly arguing with their own shadow about tax evasion. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 77 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is holding a puddle of water hostage for a ransom of dry ice. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 333 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is aggressively translating dog barks into dial-up modem sounds. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 333 },
    { title: "10-WUT: An interdimensional pizza delivery guy is trying to parallel park a horse. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 95447 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is painting the air neon pink with sheer force of will. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 13 },
    { title: "10-WUT: A cloud of aggressive cotton candy is trying to deep-fry the entire municipal water supply. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 7 },
    { title: "10-WUT: A flock of cybernetic pigeons is demanding to speak to the CEO of Earth. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 77 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is demanding a trial by combat against a stop sign. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 42 },
    { title: "10-WUT: A floating pair of neon green trousers is trying to download a car using a ham sandwich. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 1 },
    { title: "10-WUT: A floating pair of neon green trousers is demanding a trial by combat against a stop sign. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 57627 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is trying to unionize the local wildlife. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 99 },
    { title: "10-WUT: A wizard who only knows how to cast 'minor inconvenience' is holding a puddle of water hostage for a ransom of dry ice. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 99 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is throwing invisible cheese at passing pedestrians. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 1 },
    { title: "10-WUT: A herd of sentient roombas is attempting to arrest the concept of gravity. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 1 },
    { title: "10-WUT: A cloud of aggressive cotton candy is trying to legally adopt a 2004 Honda Civic. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 77 },
    { title: "10-WUT: A floating pair of neon green trousers is aggressively translating dog barks into dial-up modem sounds. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 77 },
    { title: "10-WUT: A herd of sentient roombas is painting the air neon pink with sheer force of will. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 888 },
    { title: "10-WUT: A guy convinced he's a highly compressed JPEG is demanding to speak to the CEO of Earth. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 42 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is demanding to speak to the CEO of Earth. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 77 },
    { title: "10-WUT: A time-traveling Abraham Lincoln is attempting to arrest the concept of gravity. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 1 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is holding a puddle of water hostage for a ransom of dry ice. Suspect claims they have diplomatic immunity from the planet Jupiter.", priority: "low", points: 13 },
    { title: "10-WUT: A gelatinous cube wearing a top hat is demanding that the sun turn down its brightness settings. Bystanders are clapping rhythmically for no apparent reason.", priority: "low", points: 1 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is demanding to speak to the CEO of Earth. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 333 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is loudly arguing with their own shadow about tax evasion. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 42 },
    { title: "10-WUT: A herd of sentient roombas is trying to deep-fry the entire municipal water supply. Civilian casualties include three bruised egos and a slightly confused mailbox.", priority: "low", points: 13 },
    { title: "10-WUT: A cloud of aggressive cotton candy is loudly arguing with their own shadow about tax evasion. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 333 },
    { title: "10-WUT: A flock of cybernetic pigeons is aggressively translating dog barks into dial-up modem sounds. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 42 },
    { title: "10-WUT: A herd of sentient roombas is trying to reverse-engineer a slice of pepperoni pizza. The suspect is slowly turning into a low-resolution texture.", priority: "low", points: 42 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is challenging a fire hydrant to a staring contest. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 13 },
    { title: "10-WUT: A swarm of hyper-intelligent bees is painting the air neon pink with sheer force of will. The suspect is aggressively offering everyone unwanted stock market advice.", priority: "low", points: 7 },
    { title: "10-WUT: A herd of sentient roombas is trying to deep-fry the entire municipal water supply. The incident is creating a localized disruption in the space-time continuum.", priority: "low", points: 56450 },
    { title: "10-WUT: A 50-foot tall inflatable tube man is trying to reverse-engineer a slice of pepperoni pizza. Officers report the suspect is somehow sweating liquid neon.", priority: "low", points: 13 },
    { title: "10-WUT: A herd of sentient roombas is attempting to arrest the concept of gravity. The situation is escalating because the suspect refuses to speak anything but binary.", priority: "low", points: 1 },
    { title: "10-WUT: A rogue AI installed in a smart toaster is challenging a fire hydrant to a staring contest. Suspect is threatening to reload a previous save file if arrested.", priority: "low", points: 42 },
    { title: "10-WUT: A herd of sentient roombas is trying to download a car using a ham sandwich. Suspect has successfully convinced a lamppost to join their cause.", priority: "low", points: 67985 },
    { title: "10-WUT: A holographic projection of a disgruntled cat is throwing invisible cheese at passing pedestrians. Officers are advised to approach backwards while humming the Jurassic Park theme.", priority: "low", points: 333 },
    { title: "10-33 CIVIL UNREST: Individual is heavily armed and actively trying to cause a civil war in Sector 9 by distributing illegal plasma rifles.", priority: "high", points: 49000 },
    { title: "10-71 SHOTS FIRED: Suspect has mounted a heavy machine gun on a shopping cart and is laying down suppressing fire in the supermarket.", priority: "high", points: 2500 },
    { title: "10-32 ACTIVE SHOOTER: Unhinged citizen claiming to be a sovereign state is firing indiscriminate laser blasts from their balcony.", priority: "high", points: 5000 },
    { title: "10-82 MASS RIOT: Two rival neighborhood associations have declared full-scale urban warfare over a parking dispute. Automatic weapons involved.", priority: "high", points: 8000 },
    { title: "10-33 CIVIL UNREST: A rogue political faction has barricaded the main transit hub and is declaring independence from the city.", priority: "high", points: 56740 },
    { title: "10-71 SHOTS FIRED: Suspect dual-wielding assault rifles is wandering the streets demanding a trial by combat against the Chief of Police.", priority: "high", points: 3500 },
    { title: "10-99 UNHINGED ACTIVITY: Citizen wearing full tactical armor made of stolen stop signs is firing wildly at 'invisible government surveillance drones'.", priority: "high", points: 1500 },
    { title: "10-32 ACTIVE SHOOTER: Group of heavily armed extremists has taken over a broadcasting station to announce a new civil war.", priority: "high", points: 44881 },
    { title: "10-71 SHOTS FIRED: Drive-by shooting involving two armored vans. Suspects are exchanging heavy ordinance on the freeway.", priority: "high", points: 4500 },
    { title: "10-82 MASS RIOT: Hundreds of civilians have armed themselves with stolen military surplus gear and are marching on the courthouse.", priority: "high", points: 9000 },
    { title: "10-33 CIVIL UNREST: Suspect has hijacked a city construction mech and is using it to tear down police barricades, sparking a localized uprising.", priority: "high", points: 7500 },
    { title: "10-71 SHOTS FIRED: Neighbor dispute escalated. Both parties are now entrenched in their front yards exchanging sniper fire.", priority: "high", points: 2000 },
    { title: "10-99 UNHINGED ACTIVITY: Individual injected illegal combat stims and is actively hunting police officers with a modified nailgun.", priority: "high", points: 3000 },
    { title: "10-32 ACTIVE SHOOTER: Disgruntled former military officer is pinned down in a clock tower, raining suppressing fire on passing patrols.", priority: "high", points: 6000 },
    { title: "10-82 MASS RIOT: An underground cult has surfaced and initiated a hostile takeover of Sector 4, declaring a holy civil war.", priority: "high", points: 97773 },
    { title: "10-33 CIVIL UNREST: Rebel group has tapped into the city's power grid, turning off all lights in Sector 7 to conduct a massive ambush on police.", priority: "high", points: 8500 },
    { title: "10-71 SHOTS FIRED: Suspect wearing an explosive vest is firing an LMG randomly into a crowded market, demanding to speak to the Mayor.", priority: "high", points: 15428 },
    { title: "10-99 UNHINGED ACTIVITY: Civilian believes they are living in a simulation and is shooting random people to 'force a server reset'.", priority: "high", points: 5500 },
    { title: "10-32 ACTIVE SHOOTER: Fully automated defense turret was hacked by anti-gov rebels and is now actively mowing down pedestrians.", priority: "high", points: 4000 },
    { title: "10-82 MASS RIOT: Civil war has erupted between two corporate security factions in the financial district. Heavy casualties reported.", priority: "high", points: 49140 },
    { title: "10-33 CIVIL UNREST: Agitator is broadcasting encrypted frequencies that are inciting extreme violence and rebellion in the lower sectors.", priority: "high", points: 6500 },
    { title: "10-71 SHOTS FIRED: Suspects on hoverbikes are executing a coordinated hit-and-run strafing run on the precinct headquarters.", priority: "high", points: 8000 },
    { title: "10-99 UNHINGED ACTIVITY: A man in a business suit is calmly walking down Main Street firing a bazooka at anything that moves.", priority: "high", points: 7000 },
    { title: "10-32 ACTIVE SHOOTER: Multiple active shooters reported in the underground mall. They appear to be wearing matching uniforms of a banned militia.", priority: "high", points: 9000 },
    { title: "10-82 MASS RIOT: Citizens have formed a violent mob and are actively executing city officials in the public square.", priority: "high", points: 43856 },
    { title: "10-33 CIVIL UNREST: Suspect is handing out military-grade assault weapons from the back of a truck, screaming for a violent revolution.", priority: "high", points: 8500 },
    { title: "10-71 SHOTS FIRED: Prolonged gunfight between undercover narcotics officers and heavily armed cartel members in a residential block.", priority: "high", points: 5000 },
    { title: "10-99 UNHINGED ACTIVITY: Suspect thinks the sky is falling and is shooting a minigun directly upwards into the clouds.", priority: "high", points: 1200 },
    { title: "10-32 ACTIVE SHOOTER: Subject has rigged an apartment complex with tripwires and is actively shooting at anyone who attempts to leave.", priority: "high", points: 6500 },
    { title: "10-82 MASS RIOT: A localized civil war has broken out in the industrial sector over the distribution of synthetic rations.", priority: "high", points: 7500 },
    { title: "10-33 CIVIL UNREST: Self-proclaimed warlord is forcibly conscripting civilians into their private army at gunpoint in Sector 12.", priority: "high", points: 91415 },
    { title: "10-71 SHOTS FIRED: Suspect is indiscriminately firing a railgun through the walls of an apartment building.", priority: "high", points: 8000 },
    { title: "10-99 UNHINGED ACTIVITY: Individual claims they are the god of war and is dual-wielding flamethrowers in a crowded intersection.", priority: "high", points: 4500 },
    { title: "10-32 ACTIVE SHOOTER: Rogue police unit has gone AWOL and is currently engaged in a heavy firefight with SWAT teams.", priority: "high", points: 74097 },
    { title: "10-82 MASS RIOT: Anarchist group has successfully breached the armory and is distributing heavy weaponry to inciting a city-wide civil war.", priority: "high", points: 97806 },
    { title: "10-33 CIVIL UNREST: Entire residential block has declared independence and is defending their borders with anti-aircraft weaponry.", priority: "high", points: 56780 },
    { title: "10-31 BURGLARY: Suspect seen fleeing with a bag of stolen merchandise from the electronics store. Location: Central Station.", priority: "high", points: 75 },
    { title: "10-55 PUBLIC INTOXICATION: Intoxicated individual sleeping in the vestibule of a bank. Location: Local Convenience Store.", priority: "low", points: 150 },
    { title: "10-55 INTOXICATED DRIVER: Caller reports a vehicle swerving across lanes and hitting the rumble strip. Location: Residential Cul-de-sac.", priority: "low", points: 150 },
    { title: "10-31 BURGLARY: Store manager reports overnight break-in, safe was tampered with. Location: City Library.", priority: "high", points: 150 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Public Parking Garage.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: Two subjects attempting to walk out with a cart full of unpaid groceries. Location: Riverside Park.", priority: "low", points: 150 },
    { title: "10-55 PUBLIC INTOXICATION: Subject stumbling on the sidewalk, nearly falling into traffic. Location: City Library.", priority: "low", points: 50 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Financial District.", priority: "high", points: 150 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Central Station.", priority: "high", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Caller reports a family member is off medication and becoming paranoid. Location: Midtown Shopping Center.", priority: "high", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Verbal argument escalating, caller is locked in the bathroom. Location: East End Alleyways.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: Homeowner returned to find front door forced open and electronics missing. Location: Financial District.", priority: "high", points: 50 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Riverside Park.", priority: "low", points: 50 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim bleeding from the head, suspect description provided by witnesses. Location: Abandoned Warehouse.", priority: "high", points: 75 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Highway 42 Overpass.", priority: "low", points: 75 },
    { title: "10-53 NOISE COMPLAINT: Construction noise reported well past city ordinance hours. Location: Abandoned Warehouse.", priority: "low", points: 100 },
    { title: "10-55 PUBLIC INTOXICATION: Subject being belligerent with waitstaff at a restaurant. Location: Financial District.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Abandoned Warehouse.", priority: "low", points: 75 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject standing on the bridge ledge, crisis negotiators requested. Location: Westside Clinics.", priority: "high", points: 75 },
    { title: "10-53 NOISE COMPLAINT: Loud music and party extending into the street, multiple neighbor complaints. Location: Municipal Transit Hub.", priority: "low", points: 100 },
    { title: "10-53 NOISE COMPLAINT: Construction noise reported well past city ordinance hours. Location: Main Street Intersection.", priority: "low", points: 100 },
    { title: "10-53 NOISE COMPLAINT: Large gathering creating a public nuisance in the park. Location: Highway 42 Overpass.", priority: "low", points: 150 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Suburban Sector.", priority: "low", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Residential Cul-de-sac.", priority: "high", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Industrial Park.", priority: "high", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Caller reports a family member is off medication and becoming paranoid. Location: Downtown District.", priority: "high", points: 150 },
    { title: "10-55 PUBLIC INTOXICATION: Individual urinating in public and yelling obscenities. Location: Local Convenience Store.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Caller reports a family member is off medication and becoming paranoid. Location: East End Alleyways.", priority: "high", points: 75 },
    { title: "10-54 HIT AND RUN: Suspect struck a fire hydrant, severe water leak in the area. Location: Main Street Intersection.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: Neighbor reports hearing glass breaking at the residence next door. Location: Highway 42 Overpass.", priority: "high", points: 50 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject taking photos of security cameras and exits at the bank. Location: Financial District.", priority: "low", points: 150 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Unoccupied vehicle left idling in the parking lot for over an hour. Location: Financial District.", priority: "low", points: 150 },
    { title: "10-14 PROWLER: Subject in dark clothing hopping fences in the residential neighborhood. Location: East End Alleyways.", priority: "low", points: 75 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject dropped a duffel bag in the trash can and ran away. Location: Westside Clinics.", priority: "low", points: 150 },
    { title: "10-52 MEDICAL ASSIST: Subject experiencing severe chest pains, needs police escort for medics. Location: East End Alleyways.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Caller sees an unknown subject looking into parked cars with a flashlight. Location: Highway 42 Overpass.", priority: "low", points: 75 },
    { title: "10-52 MEDICAL ASSIST: Subject experiencing severe chest pains, needs police escort for medics. Location: Main Street Intersection.", priority: "low", points: 150 },
    { title: "10-55 PUBLIC INTOXICATION: Subject being belligerent with waitstaff at a restaurant. Location: Industrial Park.", priority: "low", points: 150 },
    { title: "10-31 BURGLARY: Suspect seen fleeing with a bag of stolen merchandise from the electronics store. Location: East End Alleyways.", priority: "high", points: 50 },
    { title: "10-49 SHOPLIFTING: Two subjects attempting to walk out with a cart full of unpaid groceries. Location: Northside Residential.", priority: "low", points: 50 },
    { title: "10-50 TRAFFIC COLLISION: Vehicle struck a light pole, driver appears disoriented. Location: Downtown District.", priority: "high", points: 150 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim bleeding from the head, suspect description provided by witnesses. Location: Westside Clinics.", priority: "high", points: 50 },
    { title: "10-55 INTOXICATED DRIVER: Driver asleep at the wheel at a green light. Location: Municipal Transit Hub.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: Store manager reports overnight break-in, safe was tampered with. Location: Highway 42 Overpass.", priority: "high", points: 75 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Main Street Intersection.", priority: "low", points: 150 },
    { title: "10-14 PROWLER: Caller sees an unknown subject looking into parked cars with a flashlight. Location: Abandoned Warehouse.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: City Library.", priority: "low", points: 150 },
    { title: "10-55 INTOXICATED DRIVER: Suspect vehicle is driving at night with no headlights on, failing to maintain lane. Location: Riverside Park.", priority: "low", points: 150 },
    { title: "10-50 TRAFFIC COLLISION: Minor fender bender blocking the intersection. Location: Highway 42 Overpass.", priority: "high", points: 150 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Riverside Park.", priority: "high", points: 100 },
    { title: "10-55 PUBLIC INTOXICATION: Subject being belligerent with waitstaff at a restaurant. Location: City Library.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Individual experiencing a severe episode, refusing to leave the library. Location: City Library.", priority: "high", points: 75 },
    { title: "10-50 TRAFFIC COLLISION: Vehicle struck a light pole, driver appears disoriented. Location: City Library.", priority: "high", points: 100 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject taking photos of security cameras and exits at the bank. Location: Public Parking Garage.", priority: "low", points: 75 },
    { title: "10-49 SHOPLIFTING: Two subjects attempting to walk out with a cart full of unpaid groceries. Location: Midtown Shopping Center.", priority: "low", points: 100 },
    { title: "10-53 NOISE COMPLAINT: Construction noise reported well past city ordinance hours. Location: Abandoned Warehouse.", priority: "low", points: 75 },
    { title: "10-53 NOISE COMPLAINT: Large gathering creating a public nuisance in the park. Location: Main Street Intersection.", priority: "low", points: 150 },
    { title: "10-49 SHOPLIFTING: Two subjects attempting to walk out with a cart full of unpaid groceries. Location: City Library.", priority: "low", points: 75 },
    { title: "10-16 DOMESTIC DISTURBANCE: Caller states their spouse is intoxicated and destroying property. Location: Financial District.", priority: "low", points: 75 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Midtown Shopping Center.", priority: "high", points: 75 },
    { title: "10-14 PROWLER: Home security camera detected a masked individual checking door handles. Location: East End Alleyways.", priority: "low", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Verbal argument escalating, caller is locked in the bathroom. Location: Westside Clinics.", priority: "low", points: 50 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Unoccupied vehicle left idling in the parking lot for over an hour. Location: Industrial Park.", priority: "low", points: 100 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Westside Clinics.", priority: "low", points: 50 },
    { title: "10-53 NOISE COMPLAINT: Large gathering creating a public nuisance in the park. Location: Midtown Shopping Center.", priority: "low", points: 50 },
    { title: "10-14 PROWLER: Subject in dark clothing hopping fences in the residential neighborhood. Location: Financial District.", priority: "low", points: 100 },
    { title: "10-50 TRAFFIC COLLISION: Two vehicles involved, unknown injuries at this time. Location: Downtown District.", priority: "high", points: 100 },
    { title: "10-31 BURGLARY: Homeowner returned to find front door forced open and electronics missing. Location: Riverside Park.", priority: "high", points: 75 },
    { title: "10-53 NOISE COMPLAINT: Large gathering creating a public nuisance in the park. Location: Residential Cul-de-sac.", priority: "low", points: 50 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Highway 42 Overpass.", priority: "high", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Individual experiencing a severe episode, refusing to leave the library. Location: Financial District.", priority: "high", points: 75 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Midtown Shopping Center.", priority: "low", points: 50 },
    { title: "10-54 HIT AND RUN: Suspect vehicle lost a bumper with license plate attached at the scene. Location: Central Station.", priority: "low", points: 75 },
    { title: "10-16 DOMESTIC DISTURBANCE: Child called 911 reporting parents are fighting, hung up. Location: East End Alleyways.", priority: "low", points: 75 },
    { title: "10-16 DOMESTIC DISTURBANCE: Neighbors report loud yelling and items being thrown in apartment 4B. Location: Riverside Park.", priority: "low", points: 75 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Public Parking Garage.", priority: "low", points: 100 },
    { title: "10-55 PUBLIC INTOXICATION: Intoxicated individual sleeping in the vestibule of a bank. Location: Residential Cul-de-sac.", priority: "low", points: 150 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: City Library.", priority: "high", points: 100 },
    { title: "10-14 PROWLER: Caller sees an unknown subject looking into parked cars with a flashlight. Location: Abandoned Warehouse.", priority: "low", points: 150 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Two individuals exchanging small packages in the alley. Location: Residential Cul-de-sac.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Home security camera detected a masked individual checking door handles. Location: Suburban Sector.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: Suspect seen fleeing with a bag of stolen merchandise from the electronics store. Location: Financial District.", priority: "high", points: 100 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: East End Alleyways.", priority: "low", points: 50 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject dropped a duffel bag in the trash can and ran away. Location: Local Convenience Store.", priority: "low", points: 150 },
    { title: "10-55 INTOXICATED DRIVER: Suspect vehicle is driving at night with no headlights on, failing to maintain lane. Location: Central Station.", priority: "low", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Third-party caller reports a couple fighting physically in the front yard. Location: Municipal Transit Hub.", priority: "low", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Residential Cul-de-sac.", priority: "high", points: 100 },
    { title: "10-31 BURGLARY: Alarm company reporting multiple interior motion sensors tripped at a commercial warehouse. Location: Riverside Park.", priority: "high", points: 50 },
    { title: "10-52 MEDICAL ASSIST: Elderly subject collapsed, CPR in progress by bystanders. Location: Highway 42 Overpass.", priority: "low", points: 75 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Main Street Intersection.", priority: "high", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Central Station.", priority: "high", points: 50 },
    { title: "10-53 NOISE COMPLAINT: Large gathering creating a public nuisance in the park. Location: Public Parking Garage.", priority: "low", points: 100 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject dropped a duffel bag in the trash can and ran away. Location: East End Alleyways.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Subject in dark clothing hopping fences in the residential neighborhood. Location: Industrial Park.", priority: "low", points: 50 },
    { title: "10-49 SHOPLIFTING: Subject became combative when confronted by store security. Location: City Library.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Individual experiencing a severe episode, refusing to leave the library. Location: Midtown Shopping Center.", priority: "high", points: 50 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject taking photos of security cameras and exits at the bank. Location: Riverside Park.", priority: "low", points: 75 },
    { title: "10-49 SHOPLIFTING: Subject became combative when confronted by store security. Location: Public Parking Garage.", priority: "low", points: 100 },
    { title: "10-55 PUBLIC INTOXICATION: Subject stumbling on the sidewalk, nearly falling into traffic. Location: Public Parking Garage.", priority: "low", points: 75 },
    { title: "10-54 HIT AND RUN: Reporting party says a black sedan struck their parked car and fled northbound. Location: Public Parking Garage.", priority: "low", points: 150 },
    { title: "10-14 PROWLER: Caller sees an unknown subject looking into parked cars with a flashlight. Location: Abandoned Warehouse.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: Loss prevention has a cooperative subject detained in the back office. Location: Main Street Intersection.", priority: "low", points: 75 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim bleeding from the head, suspect description provided by witnesses. Location: East End Alleyways.", priority: "high", points: 50 },
    { title: "10-49 SHOPLIFTING: Subject became combative when confronted by store security. Location: Riverside Park.", priority: "low", points: 50 },
    { title: "10-50 TRAFFIC COLLISION: Minor fender bender blocking the intersection. Location: East End Alleyways.", priority: "high", points: 150 },
    { title: "10-50 TRAFFIC COLLISION: Driver reports hitting a stray animal, vehicle disabled. Location: Riverside Park.", priority: "high", points: 150 },
    { title: "10-16 DOMESTIC DISTURBANCE: Caller states their spouse is intoxicated and destroying property. Location: Municipal Transit Hub.", priority: "low", points: 75 },
    { title: "10-53 NOISE COMPLAINT: Loud music and party extending into the street, multiple neighbor complaints. Location: Downtown District.", priority: "low", points: 75 },
    { title: "10-50 TRAFFIC COLLISION: Rear-end collision, subjects are out of vehicles arguing. Location: Northside Residential.", priority: "high", points: 75 },
    { title: "10-16 DOMESTIC DISTURBANCE: Caller states their spouse is intoxicated and destroying property. Location: Central Station.", priority: "low", points: 50 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject dropped a duffel bag in the trash can and ran away. Location: City Library.", priority: "low", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject standing on the bridge ledge, crisis negotiators requested. Location: Riverside Park.", priority: "high", points: 150 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim bleeding from the head, suspect description provided by witnesses. Location: Abandoned Warehouse.", priority: "high", points: 75 },
    { title: "10-31 BURGLARY: Alarm company reporting multiple interior motion sensors tripped at a commercial warehouse. Location: City Library.", priority: "high", points: 75 },
    { title: "10-14 PROWLER: Caller sees an unknown subject looking into parked cars with a flashlight. Location: Local Convenience Store.", priority: "low", points: 100 },
    { title: "10-50 TRAFFIC COLLISION: Two vehicles involved, unknown injuries at this time. Location: Riverside Park.", priority: "high", points: 75 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Industrial Park.", priority: "high", points: 100 },
    { title: "10-55 PUBLIC INTOXICATION: Subject being belligerent with waitstaff at a restaurant. Location: Main Street Intersection.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Riverside Park.", priority: "low", points: 150 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Abandoned Warehouse.", priority: "low", points: 50 },
    { title: "10-55 INTOXICATED DRIVER: Driver asleep at the wheel at a green light. Location: Financial District.", priority: "low", points: 75 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject dropped a duffel bag in the trash can and ran away. Location: Downtown District.", priority: "low", points: 50 },
    { title: "10-41 AGGRAVATED ASSAULT: Subject threatened a cashier with a knife over a refund dispute. Location: Central Station.", priority: "high", points: 50 },
    { title: "10-52 MEDICAL ASSIST: Caller found a person unresponsive on a park bench. Location: Public Parking Garage.", priority: "low", points: 150 },
    { title: "10-31 BURGLARY: Alarm company reporting multiple interior motion sensors tripped at a commercial warehouse. Location: Highway 42 Overpass.", priority: "high", points: 150 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Unoccupied vehicle left idling in the parking lot for over an hour. Location: Financial District.", priority: "low", points: 75 },
    { title: "10-55 INTOXICATED DRIVER: Driver asleep at the wheel at a green light. Location: Industrial Park.", priority: "low", points: 50 },
    { title: "10-54 HIT AND RUN: Suspect struck a fire hydrant, severe water leak in the area. Location: Westside Clinics.", priority: "low", points: 150 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: East End Alleyways.", priority: "high", points: 50 },
    { title: "10-31 BURGLARY: Store manager reports overnight break-in, safe was tampered with. Location: Riverside Park.", priority: "high", points: 150 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Industrial Park.", priority: "low", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Third-party caller reports a couple fighting physically in the front yard. Location: Downtown District.", priority: "low", points: 100 },
    { title: "10-52 MEDICAL ASSIST: Caller found a person unresponsive on a park bench. Location: Abandoned Warehouse.", priority: "low", points: 75 },
    { title: "10-50 TRAFFIC COLLISION: Minor fender bender blocking the intersection. Location: Main Street Intersection.", priority: "high", points: 150 },
    { title: "10-16 DOMESTIC DISTURBANCE: Verbal argument escalating, caller is locked in the bathroom. Location: Highway 42 Overpass.", priority: "low", points: 50 },
    { title: "10-50 TRAFFIC COLLISION: Vehicle vs pedestrian, EMS is en route. Location: Northside Residential.", priority: "high", points: 150 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim reports being struck with a blunt object, suspect fled on foot. Location: Westside Clinics.", priority: "high", points: 150 },
    { title: "10-55 PUBLIC INTOXICATION: Subject being belligerent with waitstaff at a restaurant. Location: Midtown Shopping Center.", priority: "low", points: 100 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject dropped a duffel bag in the trash can and ran away. Location: Residential Cul-de-sac.", priority: "low", points: 75 },
    { title: "10-55 PUBLIC INTOXICATION: Subject being belligerent with waitstaff at a restaurant. Location: Financial District.", priority: "low", points: 75 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject standing on the bridge ledge, crisis negotiators requested. Location: Midtown Shopping Center.", priority: "high", points: 100 },
    { title: "10-55 INTOXICATED DRIVER: Caller reports a vehicle swerving across lanes and hitting the rumble strip. Location: Financial District.", priority: "low", points: 150 },
    { title: "10-54 HIT AND RUN: Suspect vehicle lost a bumper with license plate attached at the scene. Location: Westside Clinics.", priority: "low", points: 50 },
    { title: "10-16 DOMESTIC DISTURBANCE: Child called 911 reporting parents are fighting, hung up. Location: Riverside Park.", priority: "low", points: 75 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim reports being struck with a blunt object, suspect fled on foot. Location: Highway 42 Overpass.", priority: "high", points: 150 },
    { title: "10-55 PUBLIC INTOXICATION: Subject stumbling on the sidewalk, nearly falling into traffic. Location: Abandoned Warehouse.", priority: "low", points: 100 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Two individuals exchanging small packages in the alley. Location: Public Parking Garage.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Financial District.", priority: "high", points: 50 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Financial District.", priority: "low", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Caller states their spouse is intoxicated and destroying property. Location: Suburban Sector.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Westside Clinics.", priority: "high", points: 150 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Central Station.", priority: "low", points: 100 },
    { title: "10-50 TRAFFIC COLLISION: Two vehicles involved, unknown injuries at this time. Location: Public Parking Garage.", priority: "high", points: 100 },
    { title: "10-55 PUBLIC INTOXICATION: Subject being belligerent with waitstaff at a restaurant. Location: Main Street Intersection.", priority: "low", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Financial District.", priority: "high", points: 75 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Riverside Park.", priority: "low", points: 75 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Unoccupied vehicle left idling in the parking lot for over an hour. Location: Abandoned Warehouse.", priority: "low", points: 100 },
    { title: "10-54 HIT AND RUN: Reporting party says a black sedan struck their parked car and fled northbound. Location: Westside Clinics.", priority: "low", points: 50 },
    { title: "10-49 SHOPLIFTING: Loss prevention has a cooperative subject detained in the back office. Location: Residential Cul-de-sac.", priority: "low", points: 50 },
    { title: "10-14 PROWLER: Caller sees an unknown subject looking into parked cars with a flashlight. Location: Riverside Park.", priority: "low", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject standing on the bridge ledge, crisis negotiators requested. Location: Main Street Intersection.", priority: "high", points: 150 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject taking photos of security cameras and exits at the bank. Location: Westside Clinics.", priority: "low", points: 50 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Two individuals exchanging small packages in the alley. Location: Industrial Park.", priority: "low", points: 75 },
    { title: "10-55 PUBLIC INTOXICATION: Individual urinating in public and yelling obscenities. Location: Abandoned Warehouse.", priority: "low", points: 100 },
    { title: "10-53 NOISE COMPLAINT: Large gathering creating a public nuisance in the park. Location: City Library.", priority: "low", points: 75 },
    { title: "10-50 TRAFFIC COLLISION: Two vehicles involved, unknown injuries at this time. Location: Riverside Park.", priority: "high", points: 100 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Unoccupied vehicle left idling in the parking lot for over an hour. Location: Midtown Shopping Center.", priority: "low", points: 100 },
    { title: "10-50 TRAFFIC COLLISION: Vehicle vs pedestrian, EMS is en route. Location: City Library.", priority: "high", points: 100 },
    { title: "10-55 INTOXICATED DRIVER: Driver asleep at the wheel at a green light. Location: Central Station.", priority: "low", points: 75 },
    { title: "10-96 MENTAL HEALTH CRISIS: Individual experiencing a severe episode, refusing to leave the library. Location: Midtown Shopping Center.", priority: "high", points: 50 },
    { title: "10-55 PUBLIC INTOXICATION: Subject stumbling on the sidewalk, nearly falling into traffic. Location: Abandoned Warehouse.", priority: "low", points: 150 },
    { title: "10-96 MENTAL HEALTH CRISIS: Caller reports a family member is off medication and becoming paranoid. Location: Riverside Park.", priority: "high", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Suburban Sector.", priority: "high", points: 75 },
    { title: "10-55 PUBLIC INTOXICATION: Intoxicated individual sleeping in the vestibule of a bank. Location: Public Parking Garage.", priority: "low", points: 150 },
    { title: "10-52 MEDICAL ASSIST: Suspected overdose in a public restroom, Fire and EMS responding. Location: Westside Clinics.", priority: "low", points: 75 },
    { title: "10-50 TRAFFIC COLLISION: Vehicle struck a light pole, driver appears disoriented. Location: Westside Clinics.", priority: "high", points: 150 },
    { title: "10-96 MENTAL HEALTH CRISIS: Individual experiencing a severe episode, refusing to leave the library. Location: Public Parking Garage.", priority: "high", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Suburban Sector.", priority: "high", points: 50 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Highway 42 Overpass.", priority: "low", points: 100 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Two individuals exchanging small packages in the alley. Location: Riverside Park.", priority: "low", points: 150 },
    { title: "10-50 TRAFFIC COLLISION: Vehicle struck a light pole, driver appears disoriented. Location: City Library.", priority: "high", points: 75 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Local Convenience Store.", priority: "high", points: 150 },
    { title: "10-53 NOISE COMPLAINT: Construction noise reported well past city ordinance hours. Location: Downtown District.", priority: "low", points: 150 },
    { title: "10-54 HIT AND RUN: Witnesses state a pickup truck side-swiped a cyclist and kept driving. Location: Central Station.", priority: "low", points: 50 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim reports being struck with a blunt object, suspect fled on foot. Location: Central Station.", priority: "high", points: 150 },
    { title: "10-54 HIT AND RUN: Witnesses state a pickup truck side-swiped a cyclist and kept driving. Location: City Library.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Northside Residential.", priority: "low", points: 150 },
    { title: "10-55 PUBLIC INTOXICATION: Intoxicated individual sleeping in the vestibule of a bank. Location: Westside Clinics.", priority: "low", points: 150 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Two individuals exchanging small packages in the alley. Location: Residential Cul-de-sac.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Caller reports a family member is off medication and becoming paranoid. Location: Municipal Transit Hub.", priority: "high", points: 50 },
    { title: "10-49 SHOPLIFTING: Loss prevention has a cooperative subject detained in the back office. Location: Central Station.", priority: "low", points: 50 },
    { title: "10-52 MEDICAL ASSIST: Subject experiencing severe chest pains, needs police escort for medics. Location: Riverside Park.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Individual experiencing a severe episode, refusing to leave the library. Location: Highway 42 Overpass.", priority: "high", points: 50 },
    { title: "10-49 SHOPLIFTING: Loss prevention has a cooperative subject detained in the back office. Location: Financial District.", priority: "low", points: 100 },
    { title: "10-31 BURGLARY: Suspect seen fleeing with a bag of stolen merchandise from the electronics store. Location: City Library.", priority: "high", points: 100 },
    { title: "10-14 PROWLER: Home security camera detected a masked individual checking door handles. Location: Abandoned Warehouse.", priority: "low", points: 150 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Local Convenience Store.", priority: "low", points: 75 },
    { title: "10-54 HIT AND RUN: Suspect vehicle lost a bumper with license plate attached at the scene. Location: Municipal Transit Hub.", priority: "low", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Child called 911 reporting parents are fighting, hung up. Location: Main Street Intersection.", priority: "low", points: 75 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Main Street Intersection.", priority: "low", points: 75 },
    { title: "10-49 SHOPLIFTING: Loss prevention has a cooperative subject detained in the back office. Location: Riverside Park.", priority: "low", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Caller states their spouse is intoxicated and destroying property. Location: Highway 42 Overpass.", priority: "low", points: 50 },
    { title: "10-54 HIT AND RUN: Reporting party says a black sedan struck their parked car and fled northbound. Location: Midtown Shopping Center.", priority: "low", points: 150 },
    { title: "10-55 PUBLIC INTOXICATION: Individual urinating in public and yelling obscenities. Location: Industrial Park.", priority: "low", points: 100 },
    { title: "10-54 HIT AND RUN: Reporting party says a black sedan struck their parked car and fled northbound. Location: Public Parking Garage.", priority: "low", points: 75 },
    { title: "10-52 MEDICAL ASSIST: Subject experiencing severe chest pains, needs police escort for medics. Location: Municipal Transit Hub.", priority: "low", points: 50 },
    { title: "10-52 MEDICAL ASSIST: Elderly subject collapsed, CPR in progress by bystanders. Location: City Library.", priority: "low", points: 50 },
    { title: "10-41 AGGRAVATED ASSAULT: Victim reports being struck with a blunt object, suspect fled on foot. Location: Residential Cul-de-sac.", priority: "high", points: 100 },
    { title: "10-55 PUBLIC INTOXICATION: Subject stumbling on the sidewalk, nearly falling into traffic. Location: East End Alleyways.", priority: "low", points: 100 },
    { title: "10-52 MEDICAL ASSIST: Elderly subject collapsed, CPR in progress by bystanders. Location: City Library.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: Subject became combative when confronted by store security. Location: Westside Clinics.", priority: "low", points: 100 },
    { title: "10-41 AGGRAVATED ASSAULT: Subject threatened a cashier with a knife over a refund dispute. Location: Industrial Park.", priority: "high", points: 100 },
    { title: "10-14 PROWLER: Subject in dark clothing hopping fences in the residential neighborhood. Location: Westside Clinics.", priority: "low", points: 75 },
    { title: "10-14 PROWLER: Subject in dark clothing hopping fences in the residential neighborhood. Location: Midtown Shopping Center.", priority: "low", points: 75 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Central Station.", priority: "high", points: 150 },
    { title: "10-49 SHOPLIFTING: Suspect fled on foot after concealing multiple bottles of alcohol. Location: Main Street Intersection.", priority: "low", points: 75 },
    { title: "10-16 DOMESTIC DISTURBANCE: Caller states their spouse is intoxicated and destroying property. Location: Municipal Transit Hub.", priority: "low", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Caller reports a family member is off medication and becoming paranoid. Location: Financial District.", priority: "high", points: 150 },
    { title: "10-53 NOISE COMPLAINT: Construction noise reported well past city ordinance hours. Location: Westside Clinics.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: Subject became combative when confronted by store security. Location: Westside Clinics.", priority: "low", points: 50 },
    { title: "10-53 NOISE COMPLAINT: Large gathering creating a public nuisance in the park. Location: City Library.", priority: "low", points: 150 },
    { title: "10-50 TRAFFIC COLLISION: Two vehicles involved, unknown injuries at this time. Location: Main Street Intersection.", priority: "high", points: 75 },
    { title: "10-16 DOMESTIC DISTURBANCE: Child called 911 reporting parents are fighting, hung up. Location: Abandoned Warehouse.", priority: "low", points: 100 },
    { title: "10-16 DOMESTIC DISTURBANCE: Third-party caller reports a couple fighting physically in the front yard. Location: Municipal Transit Hub.", priority: "low", points: 50 },
    { title: "10-31 BURGLARY: Homeowner returned to find front door forced open and electronics missing. Location: Residential Cul-de-sac.", priority: "high", points: 75 },
    { title: "10-31 BURGLARY: Alarm company reporting multiple interior motion sensors tripped at a commercial warehouse. Location: Municipal Transit Hub.", priority: "high", points: 50 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Westside Clinics.", priority: "low", points: 100 },
    { title: "10-49 SHOPLIFTING: Subject became combative when confronted by store security. Location: Midtown Shopping Center.", priority: "low", points: 150 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Main Street Intersection.", priority: "low", points: 75 },
    { title: "10-31 BURGLARY: Suspect seen fleeing with a bag of stolen merchandise from the electronics store. Location: East End Alleyways.", priority: "high", points: 150 },
    { title: "10-31 BURGLARY: Neighbor reports hearing glass breaking at the residence next door. Location: East End Alleyways.", priority: "high", points: 150 },
    { title: "10-31 BURGLARY: Neighbor reports hearing glass breaking at the residence next door. Location: Abandoned Warehouse.", priority: "high", points: 50 },
    { title: "10-49 SHOPLIFTING: Two subjects attempting to walk out with a cart full of unpaid groceries. Location: Highway 42 Overpass.", priority: "low", points: 75 },
    { title: "10-55 INTOXICATED DRIVER: Driver asleep at the wheel at a green light. Location: Main Street Intersection.", priority: "low", points: 150 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: East End Alleyways.", priority: "low", points: 75 },
    { title: "10-31 BURGLARY: Alarm company reporting multiple interior motion sensors tripped at a commercial warehouse. Location: Westside Clinics.", priority: "high", points: 100 },
    { title: "10-96 MENTAL HEALTH CRISIS: Subject walking in traffic, yelling at passing cars. Location: Midtown Shopping Center.", priority: "high", points: 150 },
    { title: "10-41 AGGRAVATED ASSAULT: Bar fight spilled into the street, multiple subjects actively fighting. Location: Central Station.", priority: "high", points: 50 },
    { title: "10-14 PROWLER: Subject in dark clothing hopping fences in the residential neighborhood. Location: Financial District.", priority: "low", points: 75 },
    { title: "10-14 PROWLER: Caller sees an unknown subject looking into parked cars with a flashlight. Location: Northside Residential.", priority: "low", points: 150 },
    { title: "10-55 INTOXICATED DRIVER: Caller reports a vehicle swerving across lanes and hitting the rumble strip. Location: East End Alleyways.", priority: "low", points: 150 },
    { title: "10-43 SUSPICIOUS ACTIVITY: Subject dropped a duffel bag in the trash can and ran away. Location: Municipal Transit Hub.", priority: "low", points: 100 },
    { title: "10-53 NOISE COMPLAINT: Subject playing drums loudly in an open garage. Location: Residential Cul-de-sac.", priority: "low", points: 75 },
    { title: "10-55 INTOXICATED DRIVER: Suspect vehicle is driving at night with no headlights on, failing to maintain lane. Location: Public Parking Garage.", priority: "low", points: 50 },
    { title: "10-16 DOMESTIC DISTURBANCE: Verbal argument escalating, caller is locked in the bathroom. Location: Highway 42 Overpass.", priority: "low", points: 100 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Abandoned Warehouse.", priority: "low", points: 150 },
    { title: "10-49 SHOPLIFTING: Subject became combative when confronted by store security. Location: East End Alleyways.", priority: "low", points: 100 },
    { title: "10-54 HIT AND RUN: Witnesses state a pickup truck side-swiped a cyclist and kept driving. Location: Highway 42 Overpass.", priority: "low", points: 50 },
    { title: "10-14 PROWLER: Individual loitering in the alleyway behind the pharmacy. Location: Highway 42 Overpass.", priority: "low", points: 50 },
    { title: "10-96 MENTAL HEALTH CRISIS: Caller reports a family member is off medication and becoming paranoid. Location: Main Street Intersection.", priority: "high", points: 150 },
    { title: "10-WUT: Amateur hacker is aggressively rolling down the street instead of walking. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 777 },
    { title: "10-WUT: Guy claiming to be the main character is throwing empty energy drink cans at passing drones. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 100 },
    { title: "10-WUT: Man in a tin foil hat is attempting to hack the police database to change their own wanted poster picture. Property damage is imminent but no one is in danger.", priority: "low", points: 10 },
    { title: "10-WUT: Elderly cyborg is holding a hostage situation where the demands are just a nap. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 10 },
    { title: "10-WUT: Naked individual is throwing empty energy drink cans at passing drones. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 15 },
    { title: "10-WUT: Confused tourist is aggressively rolling down the street instead of walking. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 100 },
    { title: "10-WUT: Local street vendor is arguing with a smart vending machine over a rejected credit card. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 100 },
    { title: "10-WUT: Bored teenager is trying to pull over police vehicles to issue citizen speeding tickets. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Group of teenagers is arguing with a smart vending machine over a rejected credit card. Suspect claims it's just a social experiment.", priority: "low", points: 5 },
    { title: "10-WUT: Elderly cyborg is trying to pull over police vehicles to issue citizen speeding tickets. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 15 },
    { title: "10-WUT: Self-proclaimed time traveler is aggressively rolling down the street instead of walking. Property damage is imminent but no one is in danger.", priority: "low", points: 15 },
    { title: "10-WUT: Self-proclaimed time traveler is trying to bribe an officer with a half-eaten sandwich. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 777 },
    { title: "10-WUT: Rogue delivery drone is protesting against gravity and refusing to touch the ground. Suspect immediately surrendered when it started raining.", priority: "low", points: 100 },
    { title: "10-WUT: Local street vendor is holding a hostage situation where the demands are just a nap. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 777 },
    { title: "10-WUT: Rogue delivery drone is challenging police mechs to a breakdance battle. Suspect immediately surrendered when it started raining.", priority: "low", points: 777 },
    { title: "10-WUT: Man dressed as a giant hotdog is trying to pull over police vehicles to issue citizen speeding tickets. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 100 },
    { title: "10-WUT: Amateur hacker is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Property damage is imminent but no one is in danger.", priority: "low", points: 420 },
    { title: "10-WUT: Self-proclaimed time traveler is running in circles claiming they are charging their kinetic battery. Suspect immediately surrendered when it started raining.", priority: "low", points: 69 },
    { title: "10-WUT: Self-proclaimed time traveler is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Property damage is imminent but no one is in danger.", priority: "low", points: 69 },
    { title: "10-WUT: Man dressed as a giant hotdog is attempting to hack the police database to change their own wanted poster picture. Property damage is imminent but no one is in danger.", priority: "low", points: 69 },
    { title: "10-WUT: Suspect is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 5 },
    { title: "10-WUT: Cyber-enhanced mime is stuck inside a self-driving car that decided to join a local gang. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 420 },
    { title: "10-WUT: Naked individual is hacking city billboards to play vintage internet memes. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 100 },
    { title: "10-WUT: Local street vendor is attempting to hack the police database to change their own wanted poster picture. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 69 },
    { title: "10-WUT: Sentient vending machine is trying to sell extended warranties for cybernetic limbs. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 69 },
    { title: "10-WUT: Local street vendor is hacking city billboards to play vintage internet memes. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Heavily armed clown is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 777 },
    { title: "10-WUT: Confused tourist is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect immediately surrendered when it started raining.", priority: "low", points: 15 },
    { title: "10-WUT: Rogue delivery drone is threatening to delete the internet if they don't get a free pizza. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 5 },
    { title: "10-WUT: Self-proclaimed time traveler is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 69 },
    { title: "10-WUT: Disgruntled corpo worker is trying to bribe an officer with a half-eaten sandwich. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 15 },
    { title: "10-WUT: Disgruntled corpo worker is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Sentient vending machine is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 10 },
    { title: "10-WUT: Local street vendor is trying to bribe an officer with a half-eaten sandwich. Suspect immediately surrendered when it started raining.", priority: "low", points: 5 },
    { title: "10-WUT: Elderly cyborg is holding a hostage situation where the demands are just a nap. Suspect claims it's just a social experiment.", priority: "low", points: 100 },
    { title: "10-WUT: Bored teenager is arguing with a smart vending machine over a rejected credit card. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 10 },
    { title: "10-WUT: Confused tourist is arguing with a smart vending machine over a rejected credit card. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 100 },
    { title: "10-WUT: Sentient vending machine is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Officers are currently negotiating using meme soundboards.", priority: "low", points: 10 },
    { title: "10-WUT: Rogue delivery drone is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 15 },
    { title: "10-WUT: Elderly cyborg is protesting against gravity and refusing to touch the ground. Suspect immediately surrendered when it started raining.", priority: "low", points: 777 },
    { title: "10-WUT: Disgruntled corpo worker is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 420 },
    { title: "10-WUT: Amateur hacker is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Frustrated citizen is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 777 },
    { title: "10-WUT: Bored teenager is using a jetpack indoors and constantly bumping into the ceiling. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 69 },
    { title: "10-WUT: Man dressed as a giant hotdog is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 15 },
    { title: "10-WUT: Heavily armed clown is rapidly shooting in random directions with horrible accuracy (Stormtrooper Syndrome). Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 420 },
    { title: "10-WUT: Man dressed as a giant hotdog is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 69 },
    { title: "10-WUT: Disgruntled corpo worker is trying to pull over police vehicles to issue citizen speeding tickets. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Suspect is trying to bribe an officer with a half-eaten sandwich. Suspect claims it's just a social experiment.", priority: "low", points: 777 },
    { title: "10-WUT: Guy claiming to be the main character is demanding a refund from the police because they 'didn't enjoy their last arrest'. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 5 },
    { title: "10-WUT: Suspect is throwing empty energy drink cans at passing drones. Suspect claims it's just a social experiment.", priority: "low", points: 5 },
    { title: "10-WUT: Cyber-enhanced mime is trying to pull over police vehicles to issue citizen speeding tickets. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 5 },
    { title: "10-WUT: Confused tourist is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 69 },
    { title: "10-WUT: Cyber-enhanced mime is arguing with a smart vending machine over a rejected credit card. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 420 },
    { title: "10-WUT: Amateur hacker is threatening to delete the internet if they don't get a free pizza. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 5 },
    { title: "10-WUT: Suspect is throwing empty energy drink cans at passing drones. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 777 },
    { title: "10-WUT: Elderly cyborg is protesting against gravity and refusing to touch the ground. Suspect immediately surrendered when it started raining.", priority: "low", points: 15 },
    { title: "10-WUT: Rogue delivery drone is trying to pull over police vehicles to issue citizen speeding tickets. Officers are currently negotiating using meme soundboards.", priority: "low", points: 15 },
    { title: "10-WUT: Group of teenagers is throwing empty energy drink cans at passing drones. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 15 },
    { title: "10-WUT: Confused tourist is stuck inside a self-driving car that decided to join a local gang. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 15 },
    { title: "10-WUT: Disgruntled corpo worker is running in circles claiming they are charging their kinetic battery. Suspect immediately surrendered when it started raining.", priority: "low", points: 69 },
    { title: "10-WUT: Man in a tin foil hat is hacking city billboards to play vintage internet memes. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 100 },
    { title: "10-WUT: Group of teenagers is threatening to delete the internet if they don't get a free pizza. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 777 },
    { title: "10-WUT: Amateur hacker is attempting to domesticate a radioactive sewer rat. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Bored teenager is threatening to delete the internet if they don't get a free pizza. Property damage is imminent but no one is in danger.", priority: "low", points: 100 },
    { title: "10-WUT: Naked individual is challenging police mechs to a breakdance battle. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 420 },
    { title: "10-WUT: Cyber-enhanced mime is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect immediately surrendered when it started raining.", priority: "low", points: 777 },
    { title: "10-WUT: Rogue delivery drone is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 15 },
    { title: "10-WUT: Guy claiming to be the main character is hacking city billboards to play vintage internet memes. Officers are currently negotiating using meme soundboards.", priority: "low", points: 5 },
    { title: "10-WUT: Guy claiming to be the main character is reporting a stolen invisible car. Officers are currently negotiating using meme soundboards.", priority: "low", points: 420 },
    { title: "10-WUT: Man in a tin foil hat is trying to rob a bank using a banana painted black. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 15 },
    { title: "10-WUT: Group of teenagers is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 69 },
    { title: "10-WUT: Sentient vending machine is trying to use Jedi mind tricks on officers to avoid arrest. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 5 },
    { title: "10-WUT: Group of teenagers is stuck inside a self-driving car that decided to join a local gang. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 15 },
    { title: "10-WUT: Confused tourist is rapidly shooting in random directions with horrible accuracy (Stormtrooper Syndrome). Suspect immediately surrendered when it started raining.", priority: "low", points: 100 },
    { title: "10-WUT: Bored teenager is trying to sell extended warranties for cybernetic limbs. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 5 },
    { title: "10-WUT: Amateur hacker is reporting a stolen invisible car. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 15 },
    { title: "10-WUT: Suspect is throwing empty energy drink cans at passing drones. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 15 },
    { title: "10-WUT: Naked individual is protesting against gravity and refusing to touch the ground. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Rogue delivery drone is hacking city billboards to play vintage internet memes. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 420 },
    { title: "10-WUT: Naked individual is rapidly shooting in random directions with horrible accuracy (Stormtrooper Syndrome). Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 777 },
    { title: "10-WUT: Suspect is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 777 },
    { title: "10-WUT: Man dressed as a giant hotdog is rapidly shooting in random directions with horrible accuracy (Stormtrooper Syndrome). Suspect claims it's just a social experiment.", priority: "low", points: 100 },
    { title: "10-WUT: Amateur hacker is running in circles claiming they are charging their kinetic battery. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 100 },
    { title: "10-WUT: Amateur hacker is aggressively rolling down the street instead of walking. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 100 },
    { title: "10-WUT: Bored teenager is attempting to hack the police database to change their own wanted poster picture. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 5 },
    { title: "10-WUT: Man dressed as a giant hotdog is reporting a stolen invisible car. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 15 },
    { title: "10-WUT: Naked individual is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect claims it's just a social experiment.", priority: "low", points: 5 },
    { title: "10-WUT: Heavily armed clown is trying to use Jedi mind tricks on officers to avoid arrest. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 5 },
    { title: "10-WUT: Man in a tin foil hat is reporting a stolen invisible car. Suspect immediately surrendered when it started raining.", priority: "low", points: 5 },
    { title: "10-WUT: Bored teenager is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect claims it's just a social experiment.", priority: "low", points: 100 },
    { title: "10-WUT: Amateur hacker is attempting to hack the police database to change their own wanted poster picture. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 69 },
    { title: "10-WUT: Man in a tin foil hat is trying to pull over police vehicles to issue citizen speeding tickets. Suspect claims it's just a social experiment.", priority: "low", points: 100 },
    { title: "10-WUT: Amateur hacker is trying to pull over police vehicles to issue citizen speeding tickets. Officers are currently negotiating using meme soundboards.", priority: "low", points: 5 },
    { title: "10-WUT: Disgruntled corpo worker is using a jetpack indoors and constantly bumping into the ceiling. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 100 },
    { title: "10-WUT: Disgruntled corpo worker is attempting to hack the police database to change their own wanted poster picture. Suspect claims it's just a social experiment.", priority: "low", points: 10 },
    { title: "10-WUT: Man in a tin foil hat is stuck inside a self-driving car that decided to join a local gang. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Disgruntled corpo worker is trying to bribe an officer with a half-eaten sandwich. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 5 },
    { title: "10-WUT: Self-proclaimed time traveler is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 100 },
    { title: "10-WUT: Man dressed as a giant hotdog is trying to use Jedi mind tricks on officers to avoid arrest. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 777 },
    { title: "10-WUT: Sentient vending machine is dual-wielding baguettes and demanding a ransom of fine cheeses. Officers are currently negotiating using meme soundboards.", priority: "low", points: 69 },
    { title: "10-WUT: Self-proclaimed time traveler is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 100 },
    { title: "10-WUT: Local street vendor is running in circles claiming they are charging their kinetic battery. Suspect immediately surrendered when it started raining.", priority: "low", points: 69 },
    { title: "10-WUT: Man in a tin foil hat is stuck inside a self-driving car that decided to join a local gang. Suspect claims it's just a social experiment.", priority: "low", points: 69 },
    { title: "10-WUT: Disgruntled corpo worker is trying to sell extended warranties for cybernetic limbs. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 15 },
    { title: "10-WUT: Elderly cyborg is threatening to delete the internet if they don't get a free pizza. Officers are currently negotiating using meme soundboards.", priority: "low", points: 10 },
    { title: "10-WUT: Confused tourist is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect claims it's just a social experiment.", priority: "low", points: 777 },
    { title: "10-WUT: Heavily armed clown is reporting a stolen invisible car. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 15 },
    { title: "10-WUT: Suspect is trying to bribe an officer with a half-eaten sandwich. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 420 },
    { title: "10-WUT: Naked individual is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect immediately surrendered when it started raining.", priority: "low", points: 420 },
    { title: "10-WUT: Elderly cyborg is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect immediately surrendered when it started raining.", priority: "low", points: 69 },
    { title: "10-WUT: Confused tourist is trying to pull over police vehicles to issue citizen speeding tickets. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 15 },
    { title: "10-WUT: Local street vendor is throwing empty energy drink cans at passing drones. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 777 },
    { title: "10-WUT: Sentient vending machine is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 5 },
    { title: "10-WUT: Rogue delivery drone is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 10 },
    { title: "10-WUT: Local street vendor is holding a hostage situation where the demands are just a nap. Suspect claims it's just a social experiment.", priority: "low", points: 69 },
    { title: "10-WUT: Amateur hacker is trying to pull over police vehicles to issue citizen speeding tickets. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 10 },
    { title: "10-WUT: Self-proclaimed time traveler is threatening to delete the internet if they don't get a free pizza. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 100 },
    { title: "10-WUT: Elderly cyborg is stuck inside a self-driving car that decided to join a local gang. Officers are currently negotiating using meme soundboards.", priority: "low", points: 69 },
    { title: "10-WUT: Guy claiming to be the main character is trying to use Jedi mind tricks on officers to avoid arrest. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 100 },
    { title: "10-WUT: Suspect is arguing with a smart vending machine over a rejected credit card. Suspect immediately surrendered when it started raining.", priority: "low", points: 777 },
    { title: "10-WUT: Man in a tin foil hat is trying to use Jedi mind tricks on officers to avoid arrest. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 69 },
    { title: "10-WUT: Man in a tin foil hat is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect claims it's just a social experiment.", priority: "low", points: 5 },
    { title: "10-WUT: Sentient vending machine is trying to rob a bank using a banana painted black. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 15 },
    { title: "10-WUT: Amateur hacker is hacking city billboards to play vintage internet memes. Suspect claims it's just a social experiment.", priority: "low", points: 15 },
    { title: "10-WUT: Local street vendor is throwing empty energy drink cans at passing drones. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 100 },
    { title: "10-WUT: Group of teenagers is trying to bribe an officer with a half-eaten sandwich. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 69 },
    { title: "10-WUT: Amateur hacker is throwing empty energy drink cans at passing drones. Property damage is imminent but no one is in danger.", priority: "low", points: 5 },
    { title: "10-WUT: Heavily armed clown is rapidly shooting in random directions with horrible accuracy (Stormtrooper Syndrome). Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 15 },
    { title: "10-WUT: Heavily armed clown is trying to rob a bank using a banana painted black. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 15 },
    { title: "10-WUT: Frustrated citizen is throwing empty energy drink cans at passing drones. Officers are currently negotiating using meme soundboards.", priority: "low", points: 100 },
    { title: "10-WUT: Cyber-enhanced mime is attempting to hack the police database to change their own wanted poster picture. Suspect claims it's just a social experiment.", priority: "low", points: 69 },
    { title: "10-WUT: Disgruntled corpo worker is aggressively rolling down the street instead of walking. Property damage is imminent but no one is in danger.", priority: "low", points: 10 },
    { title: "10-WUT: Cyber-enhanced mime is running in circles claiming they are charging their kinetic battery. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 5 },
    { title: "10-WUT: Rogue delivery drone is reporting a stolen invisible car. Suspect immediately surrendered when it started raining.", priority: "low", points: 777 },
    { title: "10-WUT: Frustrated citizen is arguing with a smart vending machine over a rejected credit card. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 69 },
    { title: "10-WUT: Man in a tin foil hat is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 10 },
    { title: "10-WUT: Local street vendor is arguing with a smart vending machine over a rejected credit card. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 420 },
    { title: "10-WUT: Group of teenagers is aggressively rolling down the street instead of walking. Officers are currently negotiating using meme soundboards.", priority: "low", points: 69 },
    { title: "10-WUT: Bored teenager is running in circles claiming they are charging their kinetic battery. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 10 },
    { title: "10-WUT: Man in a tin foil hat is trying to use Jedi mind tricks on officers to avoid arrest. Property damage is imminent but no one is in danger.", priority: "low", points: 777 },
    { title: "10-WUT: Frustrated citizen is challenging police mechs to a breakdance battle. Property damage is imminent but no one is in danger.", priority: "low", points: 100 },
    { title: "10-WUT: Heavily armed clown is arguing with a smart vending machine over a rejected credit card. Suspect claims it's just a social experiment.", priority: "low", points: 420 },
    { title: "10-WUT: Disgruntled corpo worker is rapidly shooting in random directions with horrible accuracy (Stormtrooper Syndrome). Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 777 },
    { title: "10-WUT: Cyber-enhanced mime is trying to sell extended warranties for cybernetic limbs. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 10 },
    { title: "10-WUT: Sentient vending machine is trying to rob a bank using a banana painted black. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 15 },
    { title: "10-WUT: Self-proclaimed time traveler is attempting to hack the police database to change their own wanted poster picture. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 10 },
    { title: "10-WUT: Man dressed as a giant hotdog is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 69 },
    { title: "10-WUT: Naked individual is attempting to domesticate a radioactive sewer rat. Property damage is imminent but no one is in danger.", priority: "low", points: 5 },
    { title: "10-WUT: Bored teenager is attempting to hack the police database to change their own wanted poster picture. Property damage is imminent but no one is in danger.", priority: "low", points: 69 },
    { title: "10-WUT: Confused tourist is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 100 },
    { title: "10-WUT: Amateur hacker is attempting to domesticate a radioactive sewer rat. Suspect claims it's just a social experiment.", priority: "low", points: 69 },
    { title: "10-WUT: Frustrated citizen is protesting against gravity and refusing to touch the ground. Property damage is imminent but no one is in danger.", priority: "low", points: 777 },
    { title: "10-WUT: Cyber-enhanced mime is running in circles claiming they are charging their kinetic battery. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 15 },
    { title: "10-WUT: Bored teenager is attempting to hack the police database to change their own wanted poster picture. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 10 },
    { title: "10-WUT: Man in a tin foil hat is trying to use Jedi mind tricks on officers to avoid arrest. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 5 },
    { title: "10-WUT: Frustrated citizen is hacking city billboards to play vintage internet memes. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 5 },
    { title: "10-WUT: Bored teenager is holding a hostage situation where the demands are just a nap. Property damage is imminent but no one is in danger.", priority: "low", points: 15 },
    { title: "10-WUT: Confused tourist is arguing with a smart vending machine over a rejected credit card. Suspect immediately surrendered when it started raining.", priority: "low", points: 10 },
    { title: "10-WUT: Elderly cyborg is demanding a refund from the police because they 'didn't enjoy their last arrest'. Suspect immediately surrendered when it started raining.", priority: "low", points: 10 },
    { title: "10-WUT: Elderly cyborg is trying to rob a bank using a banana painted black. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 420 },
    { title: "10-WUT: Guy claiming to be the main character is stuck inside a self-driving car that decided to join a local gang. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 777 },
    { title: "10-WUT: Bored teenager is aggressively rolling down the street instead of walking. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 69 },
    { title: "10-WUT: Sentient vending machine is throwing empty energy drink cans at passing drones. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 5 },
    { title: "10-WUT: Suspect is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect claims it's just a social experiment.", priority: "low", points: 420 },
    { title: "10-WUT: Man in a tin foil hat is threatening to delete the internet if they don't get a free pizza. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 5 },
    { title: "10-WUT: Frustrated citizen is using a jetpack indoors and constantly bumping into the ceiling. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 69 },
    { title: "10-WUT: Local street vendor is holding a hostage situation where the demands are just a nap. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 69 },
    { title: "10-WUT: Man dressed as a giant hotdog is aggressively rolling down the street instead of walking. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 15 },
    { title: "10-WUT: Naked individual is holding a hostage situation where the demands are just a nap. Suspect claims it's just a social experiment.", priority: "low", points: 777 },
    { title: "10-WUT: Cyber-enhanced mime is reporting a stolen invisible car. Property damage is imminent but no one is in danger.", priority: "low", points: 5 },
    { title: "10-WUT: Group of teenagers is demanding a refund from the police because they 'didn't enjoy their last arrest'. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 10 },
    { title: "10-WUT: Man in a tin foil hat is aggressively rolling down the street instead of walking. Suspect immediately surrendered when it started raining.", priority: "low", points: 777 },
    { title: "10-WUT: Amateur hacker is attempting to domesticate a radioactive sewer rat. Suspect claims it's just a social experiment.", priority: "low", points: 5 },
    { title: "10-WUT: Man dressed as a giant hotdog is protesting against gravity and refusing to touch the ground. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 69 },
    { title: "10-WUT: Elderly cyborg is aggressively rolling down the street instead of walking. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 10 },
    { title: "10-WUT: Man in a tin foil hat is protesting against gravity and refusing to touch the ground. Property damage is imminent but no one is in danger.", priority: "low", points: 100 },
    { title: "10-WUT: Man in a tin foil hat is hacking city billboards to play vintage internet memes. Suspect claims it's just a social experiment.", priority: "low", points: 100 },
    { title: "10-WUT: Man dressed as a giant hotdog is trying to rob a bank using a banana painted black. Property damage is imminent but no one is in danger.", priority: "low", points: 420 },
    { title: "10-WUT: Man in a tin foil hat is attempting to domesticate a radioactive sewer rat. Suspect immediately surrendered when it started raining.", priority: "low", points: 5 },
    { title: "10-WUT: Man dressed as a giant hotdog is threatening to delete the internet if they don't get a free pizza. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 5 },
    { title: "10-WUT: Naked individual is stuck inside a self-driving car that decided to join a local gang. Officers are currently negotiating using meme soundboards.", priority: "low", points: 15 },
    { title: "10-WUT: Confused tourist is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 69 },
    { title: "10-WUT: Cyber-enhanced mime is threatening to delete the internet if they don't get a free pizza. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 15 },
    { title: "10-WUT: Suspect is trying to sell extended warranties for cybernetic limbs. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 69 },
    { title: "10-WUT: Frustrated citizen is holding a hostage situation where the demands are just a nap. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 69 },
    { title: "10-WUT: Suspect is using a jetpack indoors and constantly bumping into the ceiling. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 10 },
    { title: "10-WUT: Man dressed as a giant hotdog is holding a hostage situation where the demands are just a nap. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 10 },
    { title: "10-WUT: Elderly cyborg is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 100 },
    { title: "10-WUT: Cyber-enhanced mime is challenging police mechs to a breakdance battle. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 100 },
    { title: "10-WUT: Man in a tin foil hat is throwing empty energy drink cans at passing drones. Officers are currently negotiating using meme soundboards.", priority: "low", points: 10 },
    { title: "10-WUT: Local street vendor is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 15 },
    { title: "10-WUT: Frustrated citizen is throwing empty energy drink cans at passing drones. Property damage is imminent but no one is in danger.", priority: "low", points: 10 },
    { title: "10-WUT: Confused tourist is trying to bribe an officer with a half-eaten sandwich. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 69 },
    { title: "10-WUT: Suspect is trying to bribe an officer with a half-eaten sandwich. Officers are currently negotiating using meme soundboards.", priority: "low", points: 5 },
    { title: "10-WUT: Rogue delivery drone is holding a hostage situation where the demands are just a nap. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 5 },
    { title: "10-WUT: Suspect is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect claims it's just a social experiment.", priority: "low", points: 420 },
    { title: "10-WUT: Guy claiming to be the main character is trying to bribe an officer with a half-eaten sandwich. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 777 },
    { title: "10-WUT: Amateur hacker is challenging police mechs to a breakdance battle. Property damage is imminent but no one is in danger.", priority: "low", points: 10 },
    { title: "10-WUT: Sentient vending machine is aggressively rolling down the street instead of walking. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 15 },
    { title: "10-WUT: Group of teenagers is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 100 },
    { title: "10-WUT: Guy claiming to be the main character is holding a hostage situation where the demands are just a nap. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 10 },
    { title: "10-WUT: Elderly cyborg is holding a hostage situation where the demands are just a nap. Suspect claims it's just a social experiment.", priority: "low", points: 420 },
    { title: "10-WUT: Frustrated citizen is aggressively rolling down the street instead of walking. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 420 },
    { title: "10-WUT: Man dressed as a giant hotdog is demanding a refund from the police because they 'didn't enjoy their last arrest'. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 10 },
    { title: "10-WUT: Man in a tin foil hat is trying to pull over police vehicles to issue citizen speeding tickets. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 100 },
    { title: "10-WUT: Man dressed as a giant hotdog is aggressively rolling down the street instead of walking. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 10 },
    { title: "10-WUT: Rogue delivery drone is attempting to domesticate a radioactive sewer rat. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 420 },
    { title: "10-WUT: Confused tourist is covered in neon synth-lube, successfully evading capture by sliding through officers' hands. Suspect is offering free legal advice to the arresting officers.", priority: "low", points: 15 },
    { title: "10-WUT: Local street vendor is challenging police mechs to a breakdance battle. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 420 },
    { title: "10-WUT: Amateur hacker is attempting to domesticate a radioactive sewer rat. Property damage is imminent but no one is in danger.", priority: "low", points: 5 },
    { title: "10-WUT: Disgruntled corpo worker is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Officers are currently negotiating using meme soundboards.", priority: "low", points: 10 },
    { title: "10-WUT: Confused tourist is rapidly shooting in random directions with horrible accuracy (Stormtrooper Syndrome). Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 100 },
    { title: "10-WUT: Amateur hacker is hacking city billboards to play vintage internet memes. Suspect immediately surrendered when it started raining.", priority: "low", points: 10 },
    { title: "10-WUT: Rogue delivery drone is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 10 },
    { title: "10-WUT: Naked individual is using a jetpack indoors and constantly bumping into the ceiling. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 69 },
    { title: "10-WUT: Heavily armed clown is arguing with a smart vending machine over a rejected credit card. Suspect claims it's just a social experiment.", priority: "low", points: 5 },
    { title: "10-WUT: Confused tourist is reporting a stolen invisible car. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 777 },
    { title: "10-WUT: Sentient vending machine is trying to bribe an officer with a half-eaten sandwich. Property damage is imminent but no one is in danger.", priority: "low", points: 15 },
    { title: "10-WUT: Confused tourist is stuck inside a self-driving car that decided to join a local gang. Officers are currently negotiating using meme soundboards.", priority: "low", points: 100 },
    { title: "10-WUT: Bored teenager is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect is wearing a 'World's Best Criminal' t-shirt.", priority: "low", points: 10 },
    { title: "10-WUT: Heavily armed clown is threatening to delete the internet if they don't get a free pizza. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 15 },
    { title: "10-WUT: Bored teenager is attempting to hack the police database to change their own wanted poster picture. Suspect claims it's just a social experiment.", priority: "low", points: 420 },
    { title: "10-WUT: Disgruntled corpo worker is aggressively rolling down the street instead of walking. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 777 },
    { title: "10-WUT: Naked individual is trying to pull over police vehicles to issue citizen speeding tickets. Suspect immediately surrendered when it started raining.", priority: "low", points: 10 },
    { title: "10-WUT: Elderly cyborg is dual-wielding baguettes and demanding a ransom of fine cheeses. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 10 },
    { title: "10-WUT: Local street vendor is arguing with a smart vending machine over a rejected credit card. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 10 },
    { title: "10-WUT: Group of teenagers is throwing glitter at passing civilians and yelling 'CYBER-MAGIC'. Suspect is demanding a lawyer, a priest, and a really good sandwich.", priority: "low", points: 10 },
    { title: "10-WUT: Man dressed as a giant hotdog is reporting a stolen invisible car. Civilian bystanders are placing bets on the outcome.", priority: "low", points: 10 },
    { title: "10-WUT: Man in a tin foil hat is claiming to be from the year 3024 and demanding to speak to the Emperor of the Moon. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 15 },
    { title: "10-WUT: Disgruntled corpo worker is trying to bribe an officer with a half-eaten sandwich. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 15 },
    { title: "10-WUT: Suspect is trying to bribe an officer with a half-eaten sandwich. Officers are requesting backup because they can't stop laughing.", priority: "low", points: 10 },
    { title: "10-WUT: Elderly cyborg is running in circles claiming they are charging their kinetic battery. Property damage is imminent but no one is in danger.", priority: "low", points: 100 },
    { title: "10-WUT: Local street vendor is stuck inside a self-driving car that decided to join a local gang. Suspect is livestreaming the entire thing to 3 viewers.", priority: "low", points: 777 },
    { title: "10-WUT: Bored teenager is threatening to delete the internet if they don't get a free pizza. Suspect tripped over their own shoelaces during the getaway.", priority: "low", points: 15 },
    { title: "10-WUT: Man dressed as a giant hotdog is challenging police mechs to a breakdance battle. Suspect's cybernetic enhancements are currently updating, leaving them frozen in place.", priority: "low", points: 5 },
    { title: "10-16: Stalker actively pursuing a civilian through an alleyway.", priority: "high" , points: 98110 },
    { title: "10-54: Child exploitation syndicate raided by undercover units.", priority: "high" , points: 99791 },
    { title: "10-33: Terrorist splinter group holding hostages at a public transit hub.", priority: "high" , points: 53719 },
    { title: "10-89: Cyber-terrorism attack causing massive traffic gridlock and accidents.", priority: "high" , points: 75693 },
    { title: "10-16: Attempted sexual assault reported in a dimly lit parking structure.", priority: "high" , points: 65044 },
    { title: "10-16: Suspect arrested for distributing non-consensual explicit material.", priority: "high" , points: 72149 },
    { title: "10-54: Forced labor camp disguised as a corporate factory.", priority: "high" , points: 84522 },
    { title: "10-16: Group of individuals aggressively catcalling and cornering a citizen.", priority: "high" , points: 87008 },
    { title: "10-54: Citizens held against their will in a basement processing facility.", priority: "high" , points: 56644 },
    { title: "10-54: Hostages rescued from an illegal off-the-grid smuggling ship.", priority: "high" , points: 73496 },
    { title: "10-16: Suspect making violent, inappropriate threats to a store clerk.", priority: "high" , points: 59312 },
    { title: "10-54: Forced labor camp disguised as a corporate factory.", priority: "high" , points: 15136 },
    { title: "10-16: Intoxicated suspect grabbing and harassing citizens at a bar.", priority: "high" , points: 94574 },
    { title: "10-54: Hostages rescued from an illegal off-the-grid smuggling ship.", priority: "high" , points: 10559 },
    { title: "10-33: Domestic terrorist cell discovered assembling weapons in a residential block.", priority: "high" , points: 43428 },
    { title: "10-32: Bank manager kidnapped and held for ransom.", priority: "high" , points: 59920 },
    { title: "10-54: Child exploitation syndicate raided by undercover units.", priority: "high" , points: 21283 },
    { title: "10-54: Extortion ring kidnapping families for corporate ransom.", priority: "high" , points: 38270 },
    { title: "10-16: Individual caught secretly recording civilians in a private facility.", priority: "high" , points: 62294 },
    { title: "10-33: Heavily armed insurgents barricaded in a corporate high-rise.", priority: "high" , points: 96963 },
    { title: "10-54: Underground organ harvesting clinic discovered in the slums.", priority: "high" , points: 97613 },
    { title: "10-31: Home invasion by heavily armed suspects.", priority: "high" , points: 45802 },
    { title: "10-89: Cyber-terrorism attack causing massive traffic gridlock and accidents.", priority: "high" , points: 49964 },
    { title: "10-16: Individual caught secretly recording civilians in a private facility.", priority: "high" , points: 18667 },
    { title: "10-89: Arsonist setting fire to an occupied apartment building.", priority: "high" , points: 82923 },
    { title: "10-54: Mass grave discovered linked to a known smuggling cartel.", priority: "high" , points: 69757 },
    { title: "10-16: Aggressive individual harassing passengers on the mag-lev train.", priority: "high" , points: 29855 },
    { title: "10-16: Assault and battery with intent to commit a sexual crime.", priority: "high" , points: 59163 },
    { title: "10-54: Smugglers intercepted transporting undocumented citizens across sector borders.", priority: "high" , points: 40874 },
    { title: "10-54: Smuggling cartel moving trafficked individuals through the sewer system.", priority: "high" , points: 61668 },
    { title: "10-16: Suspect arrested for distributing non-consensual explicit material.", priority: "high" , points: 13890 },
    { title: "10-54: Extortion ring kidnapping families for corporate ransom.", priority: "high" , points: 47080 },
    { title: "10-54: Citizens held against their will in a basement processing facility.", priority: "high" , points: 78745 },
    { title: "10-16: Creep following a minor through a commercial shopping district.", priority: "high" , points: 92018 },
    { title: "10-31: Armed robbery in progress at a major financial institution.", priority: "high" , points: 24814 },
    { title: "10-16: Severe sexual harassment reported at a corporate office.", priority: "high" , points: 71544 },
    { title: "10-89: Suspicious unmarked crates emitting radiation outside a school.", priority: "high" , points: 95661 },
    { title: "10-16: Group of individuals aggressively catcalling and cornering a citizen.", priority: "high" , points: 53900 },
    { title: "10-54: Cartel safehouse breached, multiple trafficked victims found inside.", priority: "high" , points: 18721 },
    { title: "10-16: Suspect exposing themselves and threatening pedestrians.", priority: "high" , points: 39844 },
    { title: "10-33: Sniper opening fire on civilians from a rooftop in Sector [RAND_LOC].", priority: "high" , points: 57986 },
    { title: "10-89: Suspicious unmarked crates emitting radiation outside a school.", priority: "high" , points: 75666 },
    { title: "10-89: Suicide bomber intercepted at a major checkpoint.", priority: "high" , points: 12447 },
    { title: "10-16: Attempted sexual assault reported in a dimly lit parking structure.", priority: "high" , points: 45783 },
    { title: "10-16: Citizen reporting repeated, terrifying stalking behavior from an ex-partner.", priority: "high" , points: 59895 },
    { title: "10-33: Coordinated attack on a precinct substation. Officers requesting immediate backup.", priority: "high" , points: 44523 },
    { title: "10-57: Hit-and-run resulting in multiple fatalities.", priority: "high" , points: 79519 },
    { title: "10-33: Armed hijacking of a commercial transport hovercraft.", priority: "high" , points: 85227 },
    { title: "10-16: Creep following a minor through a commercial shopping district.", priority: "high" , points: 53490 },
    { title: "10-89: Suspected IED found under a corporate executive's transport.", priority: "high" , points: 82502 },
    { title: "10-54: Suspected human trafficking ring operating out of a shipping container.", priority: "high" , points: 49533 },
    { title: "10-16: Assault and battery with intent to commit a sexual crime.", priority: "high" , points: 81106 },
    { title: "10-54: Smugglers intercepted transporting undocumented citizens across sector borders.", priority: "high" , points: 41163 },
    { title: "10-54: Illegal genetic cloning and trafficking operation uncovered.", priority: "high" , points: 10659 },
    { title: "10-16: Public indecency and assault in progress in a crowded plaza.", priority: "high" , points: 95195 },
    { title: "10-54: Suspected human trafficking ring operating out of a shipping container.", priority: "high" , points: 40611 },
    { title: "10-16: Intoxicated suspect grabbing and harassing citizens at a bar.", priority: "high" , points: 50567 },
    { title: "10-89: Suspicious unmarked crates emitting radiation outside a school.", priority: "high" , points: 42475 },
    { title: "10-16: Creep following a minor through a commercial shopping district.", priority: "high" , points: 41385 },
    { title: "10-54: Syndicate auctioning trafficked humans on the dark web.", priority: "high" , points: 46194 },
    { title: "10-16: Public indecency and assault in progress in a crowded plaza.", priority: "high" , points: 84461 },
    { title: "10-54: Smuggling cartel moving trafficked individuals through the sewer system.", priority: "high" , points: 20253 },
    { title: "10-16: Suspect making violent, inappropriate threats to a store clerk.", priority: "high" , points: 69757 },
    { title: "10-16: Public indecency and assault in progress in a crowded plaza.", priority: "high" , points: 86626 },
    { title: "10-89: Bioterrorism alert - unknown chemical agent released in a subway car.", priority: "high" , points: 19834 },
    { title: "10-57: High-speed pursuit of a stolen military-grade vehicle.", priority: "high" , points: 83755 },
    { title: "10-89: Radiological dirty bomb detected in the lower sectors.", priority: "high" , points: 24656 },
    { title: "10-16: Individual caught secretly recording civilians in a private facility.", priority: "high" , points: 89318 },
    { title: "10-54: Hostages rescued from an illegal off-the-grid smuggling ship.", priority: "high" , points: 21236 },
    { title: "10-31: Coordinated smash-and-grab by a mob of 50 people.", priority: "high" , points: 85471 },
    { title: "10-33: Armed hijacking of a commercial transport hovercraft.", priority: "medium" , points: 84825 },
    { title: "10-31: Home invasion by heavily armed suspects.", priority: "medium" , points: 91990 },
    { title: "10-89: Suspicious unmarked crates emitting radiation outside a school.", priority: "medium" , points: 89470 },
    { title: "10-33: Heavily armed insurgents barricaded in a corporate high-rise.", priority: "medium" , points: 26024 },
    { title: "10-54: Extortion ring kidnapping families for corporate ransom.", priority: "medium" , points: 50589 },
    { title: "10-71: Sustained gunfight between rival organized crime syndicates.", priority: "medium" , points: 72274 },
    { title: "10-54: Kidnapping in progress - victims being loaded into an unmarked van.", priority: "medium" , points: 58304 },
    { title: "10-16: Suspect making violent, inappropriate threats to a store clerk.", priority: "medium" , points: 65318 },
    { title: "10-16: Severe sexual harassment reported at a corporate office.", priority: "medium" , points: 11641 },
    { title: "10-16: Assault and battery with intent to commit a sexual crime.", priority: "medium" , points: 78836 },
    { title: "10-54: Illegal genetic cloning and trafficking operation uncovered.", priority: "medium" , points: 69844 },
    { title: "10-54: Kidnapping in progress - victims being loaded into an unmarked van.", priority: "medium" , points: 22595 },
    { title: "10-16: Suspect exposing themselves and threatening pedestrians.", priority: "medium" , points: 12205 },
    { title: "10-89: Bioterrorism alert - unknown chemical agent released in a subway car.", priority: "medium" , points: 19140 },
    { title: "10-89: Suspected IED found under a corporate executive's transport.", priority: "medium" , points: 39113 },
    { title: "10-33: Terrorist splinter group holding hostages at a public transit hub.", priority: "medium" , points: 71135 },
    { title: "10-16: Citizen reporting repeated, terrifying stalking behavior from an ex-partner.", priority: "medium" , points: 72229 },
    { title: "10-16: Serial predator spotted loitering outside a residential complex.", priority: "medium" , points: 74411 },
    { title: "10-54: Syndicate auctioning trafficked humans on the dark web.", priority: "medium" , points: 70334 },
    { title: "10-16: Aggressive individual harassing passengers on the mag-lev train.", priority: "medium" , points: 54666 },
    { title: "10-33: Active shooter reported in Sector [RAND_LOC]. Multiple casualties.", priority: "medium" , points: 71980 },
    { title: "10-71: Officer ambushed by cartel enforcers.", priority: "medium" , points: 18842 },
    { title: "10-54: Syndicate auctioning trafficked humans on the dark web.", priority: "medium" , points: 72031 },
    { title: "10-16: Individual caught secretly recording civilians in a private facility.", priority: "medium" , points: 82044 },
    { title: "10-54: Extortion ring kidnapping families for corporate ransom.", priority: "medium" , points: 46789 },
    { title: "10-31: Armed robbery in progress at a major financial institution.", priority: "medium" , points: 70815 },
    { title: "10-54: Abduction reported - suspects matching the description of a known trafficking cartel.", priority: "medium" , points: 98381 },
    { title: "10-89: Bioterrorism alert - unknown chemical agent released in a subway car.", priority: "medium" , points: 53426 },
    { title: "10-71: Officer ambushed by cartel enforcers.", priority: "medium" , points: 76153 },
    { title: "10-16: Creep following a minor through a commercial shopping district.", priority: "medium" , points: 50620 },
    { title: "10-89: Suicide bomber intercepted at a major checkpoint.", priority: "medium" , points: 26981 },
    { title: "10-16: Group of individuals aggressively catcalling and cornering a citizen.", priority: "medium" , points: 96718 },
    { title: "10-54: Mass grave discovered linked to a known smuggling cartel.", priority: "medium" , points: 71506 },
    { title: "10-33: Armed hijacking of a commercial transport hovercraft.", priority: "medium" , points: 95213 },
    { title: "10-54: Cartel safehouse breached, multiple trafficked victims found inside.", priority: "medium" , points: 46675 },
    { title: "10-33: Extremists attempting to breach the city's power grid control center.", priority: "medium" , points: 86965 },
    { title: "10-89: Arsonist setting fire to an occupied apartment building.", priority: "medium" , points: 78544 },
    { title: "10-89: Suspected IED found under a corporate executive's transport.", priority: "medium" , points: 19925 },
    { title: "10-54: Underground organ harvesting clinic discovered in the slums.", priority: "medium" , points: 16938 },
    { title: "10-54: Forced labor camp disguised as a corporate factory.", priority: "medium" , points: 97482 },
    { title: "10-54: Suspected human trafficking ring operating out of a shipping container.", priority: "medium" , points: 71120 },
    { title: "10-33: Extremists attempting to breach the city's power grid control center.", priority: "medium" , points: 87497 },
    { title: "10-89: Radiological dirty bomb detected in the lower sectors.", priority: "medium" , points: 28243 },
    { title: "10-57: High-speed pursuit of a stolen military-grade vehicle.", priority: "medium" , points: 33691 },
    { title: "10-54: Smugglers intercepted transporting undocumented citizens across sector borders.", priority: "medium" , points: 12617 },
    { title: "10-89: Bomb threat called in at the municipal water treatment facility.", priority: "medium" , points: 57232 },
    { title: "10-33: Coordinated attack on a precinct substation. Officers requesting immediate backup.", priority: "medium" , points: 66621 },
    { title: "10-89: Cyber-terrorism attack causing massive traffic gridlock and accidents.", priority: "medium" , points: 53072 },
    { title: "10-16: Severe sexual harassment reported at a corporate office.", priority: "medium" , points: 47258 },
    { title: "10-16: Aggressive individual harassing passengers on the mag-lev train.", priority: "medium" , points: 70689 },
    { title: "10-16: Suspect making violent, inappropriate threats to a store clerk.", priority: "medium" , points: 90818 },
    { title: "10-33: Armed hijacking of a commercial transport hovercraft.", priority: "medium" , points: 33931 },
    { title: "10-54: Illegal genetic cloning and trafficking operation uncovered.", priority: "medium" , points: 13242 },
    { title: "10-16: Aggressive individual harassing passengers on the mag-lev train.", priority: "medium" , points: 53038 },
    { title: "10-54: Child exploitation syndicate raided by undercover units.", priority: "medium" , points: 13866 },
    { title: "10-16: Suspect arrested for distributing non-consensual explicit material.", priority: "medium" , points: 92906 },
    { title: "10-33: Active shooter reported in Sector [RAND_LOC]. Multiple casualties.", priority: "medium" , points: 12526 },
    { title: "10-54: Syndicate auctioning trafficked humans on the dark web.", priority: "medium" , points: 56682 },
    { title: "10-33: Sniper opening fire on civilians from a rooftop in Sector [RAND_LOC].", priority: "medium" , points: 69710 },
    { title: "10-16: Stalker actively pursuing a civilian through an alleyway.", priority: "medium" , points: 18188 },
    { title: "10-16: Citizen reporting repeated, terrifying stalking behavior from an ex-partner.", priority: "medium" , points: 72942 },
    { title: "10-71: Sustained gunfight between rival organized crime syndicates.", priority: "medium" , points: 64624 },
    { title: "10-16: Intoxicated suspect grabbing and harassing citizens at a bar.", priority: "medium" , points: 25128 },
    { title: "10-33: Heavily armed insurgents barricaded in a corporate high-rise.", priority: "medium" , points: 13208 },
    { title: "10-89: Bioterrorism alert - unknown chemical agent released in a subway car.", priority: "medium" , points: 52789 },
    { title: "10-54: Suspected human trafficking ring operating out of a shipping container.", priority: "medium" , points: 48105 },
    { title: "10-89: Suicide bomber intercepted at a major checkpoint.", priority: "medium" , points: 73065 },
    { title: "10-54: Citizens held against their will in a basement processing facility.", priority: "medium" , points: 18277 },
    { title: "10-16: Severe sexual harassment reported at a corporate office.", priority: "medium" , points: 25024 },
    { title: "10-16: Group of individuals aggressively catcalling and cornering a citizen.", priority: "medium" , points: 57725 },
    { title: "10-54: Abduction reported - suspects matching the description of a known trafficking cartel.", priority: "medium" , points: 64303 },
    { title: "10-54: Mass grave discovered linked to a known smuggling cartel.", priority: "medium" , points: 18790 },
    { title: "10-54: Smuggling cartel moving trafficked individuals through the sewer system.", priority: "medium" , points: 79794 },
    { title: "10-16: Serial predator spotted loitering outside a residential complex.", priority: "medium" , points: 93726 },
    { title: "10-54: Kidnapping in progress - victims being loaded into an unmarked van.", priority: "medium" , points: 67459 },
    { title: "10-33: Extremists attempting to breach the city's power grid control center.", priority: "medium" , points: 44446 },
    { title: "10-54: Cartel safehouse breached, multiple trafficked victims found inside.", priority: "medium" , points: 92266 },
    { title: "10-33: Coordinated attack on a precinct substation. Officers requesting immediate backup.", priority: "medium" , points: 48971 },
    { title: "10-54: Abduction reported - suspects matching the description of a known trafficking cartel.", priority: "medium" , points: 97157 },
    { title: "10-54: Child exploitation syndicate raided by undercover units.", priority: "medium" , points: 46544 },
    { title: "10-16: Suspect exposing themselves and threatening pedestrians.", priority: "low" , points: 17490 },
    { title: "10-33: Extremists attempting to breach the city's power grid control center.", priority: "low" , points: 56298 },
    { title: "10-32: Bank manager kidnapped and held for ransom.", priority: "low" , points: 37056 },
    { title: "10-33: Coordinated attack on a precinct substation. Officers requesting immediate backup.", priority: "low" , points: 21878 },
    { title: "10-54: Underground organ harvesting clinic discovered in the slums.", priority: "low" , points: 51780 },
    { title: "10-33: Domestic terrorist cell discovered assembling weapons in a residential block.", priority: "low" , points: 77247 },
    { title: "10-54: Cartel safehouse breached, multiple trafficked victims found inside.", priority: "low" , points: 72702 },
    { title: "10-16: Serial predator spotted loitering outside a residential complex.", priority: "low" , points: 94328 },
    { title: "10-32: Hostage situation at a local convenience store.", priority: "low" , points: 57156 },
    { title: "10-54: Smugglers intercepted transporting undocumented citizens across sector borders.", priority: "low" , points: 18385 },
    { title: "10-89: Bomb threat called in at the municipal water treatment facility.", priority: "low" , points: 58358 },
    { title: "10-54: Illegal genetic cloning and trafficking operation uncovered.", priority: "low" , points: 92830 },
    { title: "10-33: Domestic terrorist cell discovered assembling weapons in a residential block.", priority: "low" , points: 36175 },
    { title: "10-89: Radiological dirty bomb detected in the lower sectors.", priority: "low" , points: 90558 },
    { title: "10-33: Active shooter reported in Sector [RAND_LOC]. Multiple casualties.", priority: "low" , points: 19710 },
    { title: "10-89: Cyber-terrorism attack causing massive traffic gridlock and accidents.", priority: "low" , points: 82773 },
    { title: "10-33: Sniper opening fire on civilians from a rooftop in Sector [RAND_LOC].", priority: "low" , points: 19379 },
    { title: "10-54: Hostages rescued from an illegal off-the-grid smuggling ship.", priority: "low" , points: 36036 },
    { title: "10-33: Sniper opening fire on civilians from a rooftop in Sector [RAND_LOC].", priority: "low" , points: 74708 },
    { title: "10-33: Terrorist splinter group holding hostages at a public transit hub.", priority: "low" , points: 93114 },
    { title: "10-31: Coordinated smash-and-grab by a mob of 50 people.", priority: "low" , points: 59357 },
    { title: "10-54: Mass grave discovered linked to a known smuggling cartel.", priority: "low" , points: 22038 },
    { title: "10-16: Stalker actively pursuing a civilian through an alleyway.", priority: "low" , points: 81097 },
    { title: "10-16: Public indecency and assault in progress in a crowded plaza.", priority: "low" , points: 93314 },
    { title: "10-16: Attempted sexual assault reported in a dimly lit parking structure.", priority: "low" , points: 82512 },
    { title: "10-54: Smuggling cartel moving trafficked individuals through the sewer system.", priority: "low" , points: 84088 },
    { title: "10-54: Kidnapping in progress - victims being loaded into an unmarked van.", priority: "low" , points: 18602 },
    { title: "10-16: Citizen reporting repeated, terrifying stalking behavior from an ex-partner.", priority: "low" , points: 78765 },
    { title: "10-54: Underground organ harvesting clinic discovered in the slums.", priority: "low" , points: 86483 },
    { title: "10-16: Attempted sexual assault reported in a dimly lit parking structure.", priority: "low" , points: 36768 },
    { title: "10-16: Suspect exposing themselves and threatening pedestrians.", priority: "low" , points: 29892 },
    { title: "10-89: Radiological dirty bomb detected in the lower sectors.", priority: "low" , points: 59497 },
    { title: "10-16: Assault and battery with intent to commit a sexual crime.", priority: "low" , points: 16406 },
    { title: "10-89: Suicide bomber intercepted at a major checkpoint.", priority: "low" , points: 73619 },
    { title: "10-16: Intoxicated suspect grabbing and harassing citizens at a bar.", priority: "low" , points: 88245 },
    { title: "10-33: Domestic terrorist cell discovered assembling weapons in a residential block.", priority: "low" , points: 94176 },
    { title: "10-89: Bomb threat called in at the municipal water treatment facility.", priority: "low" , points: 41128 },
    { title: "10-33: Terrorist splinter group holding hostages at a public transit hub.", priority: "low" , points: 79800 },
    { title: "10-16: Stalker actively pursuing a civilian through an alleyway.", priority: "low" , points: 60499 },
    { title: "10-33: Heavily armed insurgents barricaded in a corporate high-rise.", priority: "low" , points: 80359 },
    { title: "10-54: Citizens held against their will in a basement processing facility.", priority: "low" , points: 52771 },
    { title: "10-33: Active shooter reported in Sector [RAND_LOC]. Multiple casualties.", priority: "low" , points: 21063 },
    { title: "10-54: Forced labor camp disguised as a corporate factory.", priority: "low" , points: 84084 },
    { title: "10-57: Hit-and-run resulting in multiple fatalities.", priority: "low" , points: 56777 },
    { title: "10-32: Hostage situation at a local convenience store.", priority: "low" , points: 72955 },
    { title: "10-89: Bomb threat called in at the municipal water treatment facility.", priority: "low" , points: 46177 },
    { title: "10-89: Suspected IED found under a corporate executive's transport.", priority: "low" , points: 16913 },
    { title: "10-16: Serial predator spotted loitering outside a residential complex.", priority: "low" , points: 38922 },
    { title: "10-54: Abduction reported - suspects matching the description of a known trafficking cartel.", priority: "low" , points: 34451 },
    { title: "10-16: Suspect arrested for distributing non-consensual explicit material.", priority: "low" , points: 30323 },
    { title: "10-24: Unsanctioned assembly of 5 citizens standing too close to each other", priority: "low" },
    { title: "10-24: Illegal gathering: 2 people spotted whispering in Sector [RAND_LOC]", priority: "high" },
    { title: "10-24: Unauthorized group of 3 individuals sharing a single umbrella", priority: "medium" },
    { title: "10-24: Illegal congregation: 3 civilians looking at the same holographic billboard", priority: "high" },
    { title: "10-24: Unsanctioned book club: 5 citizens found reading in a circle", priority: "high" },
    { title: "10-24: Unauthorized assembly: 5 people walking in the same general direction", priority: "high" },
    { title: "10-24: Illegal gathering of 6 citizens complaining about the acid rain", priority: "medium" },
    { title: "10-24: Unsanctioned group of 2 people exchanging non-approved currency", priority: "low" },
    { title: "10-24: Illegal loitering: 3 civilians waiting for a delayed hover-bus", priority: "low" },
    { title: "10-24: Unauthorized gathering: 5 people laughing at a joke simultaneously", priority: "low" },
    { title: "10-24: Illegal crowd formation: 6 individuals sharing a synth-pizza", priority: "medium" },
    { title: "10-24: Unsanctioned assembly of 3 people making unbroken eye contact", priority: "high" },
    { title: "10-24: Unauthorized group of 4 civilians sitting on a public bench", priority: "high" },
    { title: "10-24: Illegal gathering: 2 people discussing Tyrell Corp outside of work hours", priority: "medium" },
    { title: "10-24: Unsanctioned huddle: 4 citizens trying to stay warm near a exhaust vent", priority: "low" },
    { title: "10-24: Unauthorized congregation of 6 individuals looking at a stray cat", priority: "low" },
    { title: "10-24: Illegal assembly: 7 people forming an unauthorized line at a food stall", priority: "high" },
    { title: "10-24: Unsanctioned gathering of 4 citizens playing a banned card game", priority: "high" },
    { title: "10-24: Unauthorized group of 2 people wearing matching neon jackets", priority: "medium" },
    { title: "10-24: Illegal congregation: 5 civilians singing an unsanctioned song", priority: "high" },
    { title: "10-24: Unsanctioned assembly: 2 individuals protesting the latest air-tax", priority: "medium" },
    { title: "10-24: Unauthorized gathering: 2 people crying about their jobs in an alley", priority: "high" },
    { title: "10-24: Illegal crowd of 4 citizens attempting to start a flash mob", priority: "high" },
    { title: "10-24: Unsanctioned group of 2 people watching a street performer", priority: "medium" },
    { title: "10-24: Unauthorized assembly: 6 civilians comparing cybernetic upgrades", priority: "low" },
    { title: "10-24: Illegal gathering: 5 people exchanging unauthorized poetry", priority: "medium" },
    { title: "10-24: Unsanctioned congregation of 2 citizens practicing synchronized walking", priority: "high" },
    { title: "10-24: Unauthorized group of 5 individuals sharing a single data-pad", priority: "low" },
    { title: "10-24: Illegal assembly: 4 people standing in a perfect circle in Sector [RAND_LOC]", priority: "low" },
    { title: "10-24: Unsanctioned gathering of 6 civilians staring blankly at the sky", priority: "low" },
    { title: "10-24: Unauthorized crowd: 7 people trying to fix a broken hover-board together", priority: "medium" },
    { title: "10-24: Illegal congregation of 3 citizens discussing the price of synthetic water", priority: "low" },
    { title: "10-24: Unsanctioned assembly: 3 people found sleeping in the same abandoned car", priority: "medium" },
    { title: "10-24: Unauthorized group of 7 individuals taking a group selfie", priority: "low" },
    { title: "10-24: Illegal gathering: 2 civilians exchanging conspiracy theories", priority: "high" },
    { title: "10-24: Unsanctioned crowd of 7 people refusing to look at their screens", priority: "medium" },
    { title: "10-24: Unauthorized assembly: 7 citizens organizing a neighborhood watch", priority: "medium" },
    { title: "10-24: Illegal congregation: 5 people trading illegal organic apples", priority: "high" },
    { title: "10-24: Unsanctioned gathering of 6 civilians breathing the same filtered air", priority: "high" },
    { title: "10-24: Unauthorized group of 5 individuals participating in a staring contest", priority: "high" },
    { title: "10-24: Illegal assembly: 6 people attempting to unionize near Sector [RAND_LOC]", priority: "high" },
    { title: "10-24: Unsanctioned congregation of 5 citizens sharing unauthorized memories", priority: "high" },
    { title: "10-24: Unauthorized crowd of 3 people looking for a lost synth-dog", priority: "high" },
    { title: "10-24: Illegal gathering: 2 civilians trading unencrypted data drives", priority: "medium" },
    { title: "10-24: Unsanctioned assembly: 4 people found holding hands", priority: "low" },
    { title: "10-24: Unauthorized group of 6 individuals meditating in a public sector", priority: "low" },
    { title: "10-24: Illegal congregation of 3 citizens betting on rat races", priority: "high" },
    { title: "10-24: Unsanctioned gathering: 3 people forming an impromptu boy band", priority: "medium" },
    { title: "10-24: Unauthorized assembly: 3 civilians questioning the authority of the MCPD", priority: "low" },
    { title: "10-24: Illegal group of 3 people standing suspiciously quiet in Sector [RAND_LOC]", priority: "low" },
