...
dbSearchBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
        ...
        if (Math.abs(h) % 10 < 3) { // 30% chance for random queries
            let idx = Math.abs(h) % 20 + 1;
        let exts = {1:'png', 2:'jpg', 3:'jpg', 4:'jpg', 5:'jpg', 6:'png', 7:'png', 8:'jpg', 9:'png', 10:'png', 11:'png', 12:'png', 13:'png', 14:'png', 15:'png', 16:'png', 17:'jpg', 18:'png', 19:'png', 20:'png'};
            let ext = exts[idx];
